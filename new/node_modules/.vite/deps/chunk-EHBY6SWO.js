import {
  getExternalProps,
  useDebounceCallback
} from "./chunk-DQ3SLYQ2.js";
import {
  InfoLinkLabelContext
} from "./chunk-VEBN3CBM.js";
import {
  custom_css_properties_default,
  useFormFieldContext
} from "./chunk-Y4O4AWGD.js";
import {
  useMobile
} from "./chunk-7FDAOWXY.js";
import {
  useVisualContext
} from "./chunk-IDWIQRNZ.js";
import {
  LinkDefaultVariantContext
} from "./chunk-O5AKT4QV.js";
import {
  useContainerQuery
} from "./chunk-NVQIR4OB.js";
import {
  InternalSpinner,
  KeyCode,
  TabTrap,
...
var useSearchProps = (type, disabled, readOnly, value, inputRef, onChange) => {
  const searchProps = {};
  const handleIconClick = (0, import_react8.useCallback)(() => {
    var _a;
...
function InternalInput(_a, ref) {
  ...
  return import_react9.default.createElement(
    ...
    __leftIcon && import_react9.default.createElement(
      "span",
      { onClick: __onLeftIconClick, className: styles_css_default6["input-icon-left"] },
      import_react9.default.createElement(internal_default, { name: __leftIcon, variant: disabled || readOnly ? "disabled" : __leftIconVariant })
    ),
    import_react9.default.createElement("input", Object.assign({ ref: mergedRef }, attributes)),
    __rightIcon && import_react9.default.createElement(
      "span",
...
var internal_default5 = import_react9.default.forwardRef(InternalInput);
...
var CheckboxIcon = (_a) => {
  ...
  return import_react12.default.createElement(
    ...
    import_react12.default.createElement("rect", { className: clsx_m_default(styles_css_default9["styled-box"], {
    ...
    checked || indeterminate ? import_react12.default.createElement("polyline", { className: clsx_m_default(styles_css_default9["styled-line"], {
...
var Highlight = ({ str }) => str ? import_react13.default.createElement("span", { className: styles_css_default10["filtering-match-highlight"] }, str) : null;
function HighlightMatch({ str, highlightText }) {
  if (!str || !highlightText) {
    return import_react13.default.createElement("span", null, str);
  }
  if (str === highlightText) {
    return import_react13.default.createElement(Highlight, { str });
  }
  const { noMatches, matches } = splitOnFiltering(str, highlightText);
  const highlighted = [];
  noMatches.forEach((noMatch, idx) => {
    highlighted.push(import_react13.default.createElement("span", { key: `noMatch-${idx}` }, noMatch));
    if (matches && idx < matches.length) {
      highlighted.push(import_react13.default.createElement(Highlight, { key: `match-${idx}`, str: matches[idx] }));
    }
  });
  return import_react13.default.createElement("span", null, highlighted);
}
...
// node_modules/@cloudscape-design/components/internal/components/option/option-parts.js
var Label = ({ label, prefix, highlightText, triggerVariant }) => import_react14.default.createElement(
  "span",
  ...
  prefix && import_react14.default.createElement(
    "span",
    { className: clsx_m_default(styles_css_default10["label-prefix"], triggerVariant && styles_css_default10["trigger-variant"]) },
    prefix,
    " "
  ),
  import_react14.default.createElement(HighlightMatch, { str: label, highlightText })
);
var LabelTag = ({ labelTag, highlightText, triggerVariant }) => labelTag ? import_react14.default.createElement(
  "span",
  { className: clsx_m_default(styles_css_default10["label-tag"], triggerVariant && styles_css_default10["trigger-variant"]) },
  import_react14.default.createElement(HighlightMatch, { str: labelTag, highlightText })
) : null;
var Description = ({ description, highlightedOption, highlightText, selectedOption, triggerVariant }) => description ? import_react14.default.createElement(
  "span",
  ...
  import_react14.default.createElement(HighlightMatch, { str: description, highlightText })
) : null;
var Tags = ({ tags, highlightedOption, highlightText, selectedOption, triggerVariant }) => tags ? import_react14.default.createElement("span", { className: clsx_m_default(styles_css_default10.tags, {
  [styles_css_default10.highlighted]: highlightedOption,
  [styles_css_default10.selected]: selectedOption
}) }, tags.map((tag, idx) => import_react14.default.createElement(
  "span",
  { key: idx, className: clsx_m_default(styles_css_default10.tag, triggerVariant && styles_css_default10["trigger-variant"]) },
  import_react14.default.createElement(HighlightMatch, { str: tag, highlightText })
))) : null;
var FilteringTags = ({ filteringTags, highlightedOption, highlightText, selectedOption, triggerVariant }) => {
  ...
  return import_react14.default.createElement("span", { className: clsx_m_default(styles_css_default10.tags, {
    [styles_css_default10.highlighted]: highlightedOption,
    [styles_css_default10.selected]: selectedOption
    ...
    if (match) {
      return import_react14.default.createElement(
        ...
        import_react14.default.createElement(HighlightMatch, { str: filteringTag, highlightText })
      );
    }
    return null;
  }));
...
var OptionIcon = (props2) => {
  ...
  return import_react14.default.createElement(
    ...
    import_react14.default.createElement(internal_default, Object.assign({}, props2))
  );
};
...
var Option = (_a) => {
  ...
  const icon = option.__customIcon || import_react15.default.createElement(OptionIcon, { name: option.iconName, url: option.iconUrl, svg: option.iconSvg, alt: option.iconAlt, size: option.description || option.tags ? "big" : "normal" });
  ...
  return import_react15.default.createElement(
    ...
    import_react15.default.createElement(
      ...
      import_react15.default.createElement(
        ...
        import_react15.default.createElement(Label, { label: (_e = option.label) !== null && _e !== void 0 ? _e : option.value, prefix: option.__labelPrefix, highlightText, triggerVariant }),
        import_react15.default.createElement(LabelTag, { labelTag: option.labelTag, highlightText, triggerVariant })
      ),
      import_react15.default.createElement(Description, { description: option.description, highlightedOption, selectedOption, highlightText, triggerVariant }),
      import_react15.default.createElement(Tags, { tags: option.tags, highlightedOption, selectedOption, highlightText, triggerVariant }),
      import_react15.default.createElement(FilteringTags, { filteringTags: option.filteringTags, highlightedOption, selectedOption, highlightText, triggerVariant })
    )
  );
};
...
var SelectableItem = (_a, ref) => {
  ...
  const screenReaderContentRef = (0, import_react16.useRef)(null);
  ...
  return import_react16.default.createElement(
    ...
    import_react16.default.createElement("div", { className: clsx_m_default(styles_css_default13["option-content"], styles_css_default12["option-content"]), ref: contentRef }, content),
    import_react16.default.createElement("div", { className: styles_css_default13["measure-strut"], ref }),
    import_react16.default.createElement("div", { className: styles_css_default13["screenreader-content"], ref: screenReaderContentRef })
  );
};
var selectable_item_default = import_react16.default.forwardRef(SelectableItem);
...
var Item = (_a, ref) => {
  ...
  return import_react17.default.createElement(
    ...
    import_react17.default.createElement(
      ...
      hasCheckbox && !isParent && import_react17.default.createElement(
        "div",
        { className: styles_css_default7.checkbox },
        import_react17.default.createElement(checkbox_icon_default, { checked: selected || false, disabled: option.disabled })
      ),
      import_react17.default.createElement(option_default, { option: Object.assign(Object.assign({}, wrappedOption), { disabled }), highlightedOption: highlighted, selectedOption: selected, highlightText: filteringValue, isGroupOption: isParent }),
      !hasCheckbox && !isParent && selected && import_react17.default.createElement(
        "div",
        { className: styles_css_default7["selected-icon"] },
        import_react17.default.createElement(internal_default, { name: "check" })
      ),
      isDisabledWithReason && import_react17.default.createElement(
        import_react17.default.Fragment,
        null,
        descriptionEl,
        highlighted && import_react17.default.createElement(Tooltip, { className: styles_css_default7["disabled-reason-tooltip"], trackRef: internalRef, value: disabledReason, position: "right", hideOnOverscroll: true })
      )
    )
  );
};
var item_default = import_react17.default.memo(import_react17.default.forwardRef(Item));
...
var MultiSelectItem = (_a, ref) => {
  ...
  return import_react18.default.createElement(
    ...
    import_react18.default.createElement(
      "div",
      { className },
      hasCheckbox && import_react18.default.createElement(
        "div",
        { className: styles_css_default7.checkbox },
        import_react18.default.createElement(checkbox_icon_default, { checked: selected, indeterminate: isParent && indeterminate, disabled: option.disabled })
      ),
...
var multiselect_item_default = import_react18.default.memo(import_react18.default.forwardRef(MultiSelectItem));
...
var renderOptions = ({ options, getOptionProps, filteringValue, highlightType, checkboxes = false, hasDropdownStatus, virtualItems, useInteractiveGroups, screenReaderContent, ariaSetsize }) => {
  return options.map((option, index) => {
    ...
    return import_react19.default.createElement(ListItem, Object.assign({ key: globalIndex }, props2, { virtualPosition: virtualItem && virtualItem.start, ref: virtualItem && virtualItem.measureRef, padBottom, screenReaderContent, ariaPosinset: globalIndex + 1, ariaSetsize, highlightType: highlightType.type }));
  });
};
...
var PlainList = ({ menuProps, getOptionProps, filteredOptions, filteringValue, highlightType, checkboxes, hasDropdownStatus, listBottom, useInteractiveGroups, screenReaderContent }, ref) => {
  ...
  (0, import_react20.useImperativeHandle)(ref, () => (index) => {
    var _a;
  ...
  return import_react20.default.createElement(
    ...
    listBottom ? import_react20.default.createElement("li", { role: "option", className: styles_css_default7["list-bottom"] }, listBottom) : null
  );
};
var plain_list_default = (0, import_react20.forwardRef)(PlainList);
...
var ButtonTrigger = (_a, ref) => {
  ...
  return import_react21.default.createElement(
    ...
    !hideCaret && import_react21.default.createElement(
      ...
      import_react21.default.createElement(internal_default, { name: "caret-down-filled", variant: disabled || readOnly ? "disabled" : "normal" })
    )
  );
};
...
// node_modules/@cloudscape-design/components/select/parts/trigger.js
var Trigger = import_react22.default.forwardRef(({ ariaLabelledby, ariaDescribedby, controlId, invalid, inlineLabelText, warning, triggerProps, selectedOption, selectedOptions, triggerVariant, inFilteringToken, isOpen, placeholder, disabled, readOnly }, ref) => {
  const isVisualRefresh = useVisualRefresh();
  ...
  if (triggerVariant === "tokens") {
    if (selectedOptions === null || selectedOptions === void 0 ? void 0 : selectedOptions.length) {
      triggerContent = import_react22.default.createElement(
        ...
        import_react22.default.createElement("span", { className: styles_css_default7["inline-token-list"] }, selectedOptions.map(({ label }, i) => import_react22.default.createElement("span", { key: i, className: styles_css_default7["inline-token"] }, label))),
        import_react22.default.createElement(
          "span",
          { className: styles_css_default7["inline-token-counter"], id: triggerContentId },
          import_react22.default.createElement("span", { className: styles_css_default7["inline-token-hidden-placeholder"] }, placeholder),
          import_react22.default.createElement(
            "span",
            null,
            "(",
      ...
      triggerContent = import_react22.default.createElement("span", { "aria-disabled": "true", className: clsx_m_default(styles_css_default7.placeholder, styles_css_default7.trigger), id: triggerContentId }, placeholder);
    }
    ...
    triggerContent = import_react22.default.createElement("span", { id: triggerContentId, className: styles_css_default7.trigger }, selectedOption.label || selectedOption.value);
  }
  const mergedRef = useMergeRefs(triggerProps.ref, ref);
  const triggerButton = import_react22.default.createElement(button_trigger_default, Object.assign({}, triggerProps, { id, ref: mergedRef, pressed: isOpen, disabled, readOnly, invalid, warning: warning && !invalid, inFilteringToken, inlineTokens: triggerVariant === "tokens", ariaDescribedby, ariaLabelledby: ariaLabelledbyIds }), triggerContent);
  return import_react22.default.createElement(import_react22.default.Fragment, null, inlineLabelText ? import_react22.default.createElement(
    "div",
    { className: styles_css_default7["inline-label-wrapper"] },
    import_react22.default.createElement("label", { htmlFor: controlId, className: clsx_m_default(styles_css_default7["inline-label"], disabled && styles_css_default7["inline-label-disabled"]) }, inlineLabelText),
    import_react22.default.createElement("div", { className: styles_css_default7["inline-label-trigger-wrapper"] }, triggerButton)
  ) : import_react22.default.createElement(import_react22.default.Fragment, null, triggerButton));
});
...
function useRect(nodeRef, initialRect) {
  ...
  var _React$useState = import_react23.default.useState(nodeRef.current), element = _React$useState[0], setElement = _React$useState[1];
  var _React$useReducer = import_react23.default.useReducer(rectReducer, initialRect), rect = _React$useReducer[0], dispatch = _React$useReducer[1];
  var initialRectSet = import_react23.default.useRef(false);
...
function useVirtual(_ref) {
  ...
  var latestRef = import_react23.default.useRef({
    scrollOffset: 0,
    measurements: []
  });
  var _React$useState = import_react23.default.useState(0), scrollOffset = _React$useState[0], setScrollOffset = _React$useState[1];
  latestRef.current.scrollOffset = scrollOffset;
  var useMeasureParent = useObserver || useRect;
  var _useMeasureParent = useMeasureParent(parentRef, initialRect), outerSize = _useMeasureParent[sizeKey];
  latestRef.current.outerSize = outerSize;
  var defaultScrollToFn = import_react23.default.useCallback(function(offset) {
    if (parentRef.current) {
      parentRef.current[scrollKey] = offset;
    }
  }, [parentRef, scrollKey]);
  var resolvedScrollToFn = scrollToFn || defaultScrollToFn;
  scrollToFn = import_react23.default.useCallback(function(offset) {
    resolvedScrollToFn(offset, defaultScrollToFn);
  }, [defaultScrollToFn, resolvedScrollToFn]);
  var _React$useState2 = import_react23.default.useState({}), measuredCache = _React$useState2[0], setMeasuredCache = _React$useState2[1];
  var measure = import_react23.default.useCallback(function() {
    return setMeasuredCache({});
  }, []);
  var pendingMeasuredCacheIndexesRef = import_react23.default.useRef([]);
  var measurements = import_react23.default.useMemo(function() {
  ...
  var scrollOffsetFnRef = import_react23.default.useRef(scrollOffsetFn);
  ...
  var indexes = import_react23.default.useMemo(function() {
  ...
  var measureSizeRef = import_react23.default.useRef(measureSize);
  measureSizeRef.current = measureSize;
  var virtualItems = import_react23.default.useMemo(function() {
    var virtualItems2 = [];
  ...
  var scrollToOffset = import_react23.default.useCallback(function(toOffset, _temp) {
  ...
  var tryScrollToIndex = import_react23.default.useCallback(function(index, _temp2) {
  ...
  var scrollToIndex = import_react23.default.useCallback(function() {
...
function useVirtual2({ items, parentRef, estimateSize }) {
  ...
  const measuresCache = (0, import_react24.useRef)(/* @__PURE__ */ new WeakMap());
  ...
  const virtualItems = (0, import_react24.useMemo)(() => rowVirtualizer.virtualItems.map((virtualItem) => Object.assign(Object.assign({}, virtualItem), { measureRef: (node) => {
    var _a;
...
var VirtualList = (props2, ref) => {
  return props2.menuProps.open ? import_react25.default.createElement(VirtualListOpen, Object.assign({}, props2, { ref })) : import_react25.default.createElement(VirtualListClosed, Object.assign({}, props2, { ref }));
};
var VirtualListOpen = (0, import_react25.forwardRef)(({ menuProps, getOptionProps, filteredOptions, filteringValue, highlightType, checkboxes, hasDropdownStatus, listBottom, useInteractiveGroups, screenReaderContent }, ref) => {
  const [width, menuMeasureRef] = useContainerQuery((rect) => rect.contentBoxWidth, []);
  const menuRefObject = (0, import_react25.useRef)(null);
  ...
  const { virtualItems, totalSize, scrollToIndex } = useVirtual2({
    ...
    estimateSize: (0, import_react25.useCallback)(() => 31, [width, filteringValue])
  });
  (0, import_react25.useImperativeHandle)(ref, () => (index) => {
  ...
  return import_react25.default.createElement(
    ...
    import_react25.default.createElement("div", { "aria-hidden": "true", key: "total-size", className: styles_css_default7["layout-strut"], style: { height: totalSize } }),
    finalOptions,
    listBottom ? import_react25.default.createElement("li", { role: "option", className: styles_css_default7["list-bottom"] }, listBottom) : null
  );
});
var VirtualListClosed = (0, import_react25.forwardRef)(({ menuProps, listBottom }, ref) => {
  (0, import_react25.useImperativeHandle)(ref, () => () => {
  }, []);
  return import_react25.default.createElement(options_list_default, Object.assign({}, menuProps, { ref: menuProps.ref }), listBottom ? import_react25.default.createElement("li", { role: "option", className: styles_css_default7["list-bottom"] }, listBottom) : null);
});
var virtual_list_default = (0, import_react25.forwardRef)(VirtualList);
...
function useAnnouncement({ announceSelected, highlightedOption, getParent, selectedAriaLabel, renderHighlightedAriaLive }) {
  const prevAnnouncedGroup = (0, import_react26.useRef)(void 0);
...
var useLoadItems = ({ onLoadItems, options, statusType }) => {
  const prevFilteringText = (0, import_react27.useRef)(void 0);
...
function useNativeSearch({ isEnabled, options, highlightOption, highlightedOption, useInteractiveGroups }) {
  const value = (0, import_react28.useRef)("");
...
function useHighlightedOption({ options, isHighlightable }) {
  const [highlightedIndex, setHighlightedIndexState] = (0, import_react29.useState)(-1);
  const [highlightType, setHighlightType] = (0, import_react29.useState)(new HighlightType("keyboard"));
  const setHighlightedIndex = (0, import_react29.useCallback)((index, newHighlightType) => {
  ...
  const highlightOption = (0, import_react29.useCallback)((option, highlightType2) => {
...
var useOpenState = ({ onOpen, onClose, defaultOpen = false }) => {
  ...
  const [openedWithKeyboard, setOpenedWithKeyboard] = (0, import_react30.useState)(false);
...
function useSelect({ selectedOptions, updateSelectedOption, options, filteringType, onBlur, onFocus, externalRef, keepOpen, embedded, fireLoadItems, setFilteringValue, useInteractiveGroups = false, statusType }) {
  ...
  const filterRef = (0, import_react31.useRef)(null);
...
// node_modules/@cloudscape-design/components/select/internal.js
var InternalSelect = import_react32.default.forwardRef((_a, externalRef) => {
  var _b;
  ...
  const [filteringValue, setFilteringValue] = (0, import_react32.useState)("");
  ...
  const scrollToIndex = (0, import_react32.useRef)(null);
  ...
  const filter = import_react32.default.createElement(filter_default, Object.assign({ clearAriaLabel: filteringClearAriaLabel, filteringType, placeholder: filteringPlaceholder, ariaLabel: filteringAriaLabel, ariaRequired, value: filteringValue }, getFilterProps()));
  const trigger = import_react32.default.createElement(trigger_default, Object.assign({ ref: triggerRef, placeholder, disabled, readOnly, triggerVariant, triggerProps: getTriggerProps(disabled, autoFocus), selectedOption, isOpen, inFilteringToken: __inFilteringToken, inlineLabelText }, formFieldContext, { controlId, ariaLabelledby: joinStrings(formFieldContext.ariaLabelledby, selectAriaLabelId) }));
...
var Select = import_react33.default.forwardRef((_a, ref) => {
  ...
  return import_react33.default.createElement(internal_default6, Object.assign({ options, filteringType, statusType, triggerVariant }, externalProps, baseComponentProps, { ref }, getAnalyticsMetadataAttribute({ component: componentAnalyticsMetadata })));
});
...
//# sourceMappingURL=chunk-EHBY6SWO.js.map

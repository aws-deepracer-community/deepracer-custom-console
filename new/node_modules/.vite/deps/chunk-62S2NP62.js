...
function useForwardFocus(mainRef, controlRef) {
  (0, import_react2.useImperativeHandle)(mainRef, () => ({
    focus(...args) {
      var _a2;
...
var InternalIcon = (_a2) => {
  var { name, size = "normal", variant = "normal", url, alt, svg, badge, __internalRootRef = null } = _a2, props = __rest(_a2, ["name", "size", "variant", "url", "alt", "svg", "badge", "__internalRootRef"]);
  ...
  return import_react4.default.createElement("span", Object.assign({}, baseProps, {
...
function InternalSpinner(_a2) {
  var { size = "normal", variant = "normal", __internalRootRef } = _a2, props = __rest(_a2, ["size", "variant", "__internalRootRef"]);
  const baseProps = getBaseProps(props);
  return import_react5.default.createElement(
    "span",
    Object.assign({}, baseProps, { className: clsx_m_default(baseProps.className, styles_css_default3.root, styles_css_default3[`size-${size}`], styles_css_default3[`variant-${variant}`]), ref: __internalRootRef }),
    import_react5.default.createElement("span", { className: clsx_m_default(styles_css_default3.circle, styles_css_default3["circle-left"]) }),
    import_react5.default.createElement("span", { className: clsx_m_default(styles_css_default3.circle, styles_css_default3["circle-right"]) })
  );
}
...
function IconWrapper(_a2) {
  ...
  return React4.createElement(internal_default, { className: clsx_m_default(styles_css_default.icon, styles_css_default[`icon-${getIconAlign(props)}`], props.iconClass), name: iconName, url: iconUrl, svg: iconSvg, alt: iconAlt, size: iconSize, badge });
}
function LeftIcon(props) {
  if (props.loading) {
    return React4.createElement(InternalSpinner, { className: clsx_m_default(styles_css_default.icon, styles_css_default["icon-left"]) });
...
function ScreenreaderOnly(props) {
  return import_react6.default.createElement("span", Object.assign({}, props, { className: clsx_m_default(styles_css_default4.root, props.className) }));
}
...
// node_modules/@cloudscape-design/components/internal/components/live-region/index.js
var live_region_default = (0, import_react7.memo)(LiveRegion);
function LiveRegion(_a2) {
  ...
  const sourceRef = (0, import_react7.useRef)(null);
  ...
  return import_react7.default.createElement(
    ...
    null,
    visible && !source && import_react7.default.createElement(TagName, { ref: sourceRef, id }, children),
    import_react7.default.createElement(
      ScreenreaderOnly,
      Object.assign({}, restProps, { className: clsx_m_default(styles_css_default5.root, restProps.className) }),
      !visible && !source && import_react7.default.createElement(TagName, { ref: sourceRef, "aria-hidden": "true" }, children),
      import_react7.default.createElement("span", { ref: targetRef, "aria-atomic": "true", "aria-live": assertive ? "assertive" : "polite" })
    )
  );
}
...
function useButtonContext() {
  return (0, import_react8.useContext)(ButtonContext);
}
...
var useFunnelNameSelector = () => {
  const context = (0, import_react10.useContext)(FunnelNameSelectorContext);
  return context;
};
...
function useEffectOnUpdate(callback, deps) {
  const isFirstRender = (0, import_react11.useRef)(true);
...
var SingleTabStopNavigationContext = (0, import_react13.createContext)(defaultValue);
function useSingleTabStopNavigation(focusable, options) {
  var _a2;
  const { navigationActive: contextNavigationActive, registerFocusable } = (0, import_react13.useContext)(SingleTabStopNavigationContext);
  const [focusTargetActive, setFocusTargetActive] = (0, import_react13.useState)(false);
...
// node_modules/@cloudscape-design/components/button/internal.js
var InternalButton = import_react14.default.forwardRef((_a2, ref) => {
  ...
  const buttonContent = import_react14.default.createElement(
    import_react14.default.Fragment,
    null,
    import_react14.default.createElement(LeftIcon, Object.assign({}, iconProps)),
    shouldHaveContent && import_react14.default.createElement("span", { className: styles_css_default.content }, children),
    import_react14.default.createElement(RightIcon, Object.assign({}, iconProps))
  );
  ...
  if (isAnchor) {
    return (
      ...
      import_react14.default.createElement(
        import_react14.default.Fragment,
        null,
        import_react14.default.createElement("a", Object.assign({}, buttonProps, {
          href,
          target,
        ...
        loading && loadingText && import_react14.default.createElement(live_region_default, null, loadingText)
      )
    );
  }
  return import_react14.default.createElement(
    import_react14.default.Fragment,
    null,
    import_react14.default.createElement("button", Object.assign({}, buttonProps, { type: formAction === "none" ? "button" : "submit", disabled: disabled && !__focusable, "aria-disabled": hasAriaDisabled ? true : void 0 }), buttonContent),
    loading && loadingText && import_react14.default.createElement(live_region_default, null, loadingText)
  );
});
...
//# sourceMappingURL=chunk-62S2NP62.js.map

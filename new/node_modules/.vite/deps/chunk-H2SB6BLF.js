...
import {
  ...
  useInternalI18n
} from "./chunk-VBND7JGL.js";
import {
  FunnelMetrics,
  useFunnel,
  useFunnelStep,
  useFunnelSubStep
} from "./chunk-HDQYTQQB.js";
import {
  isDevelopment
...
var Highlight = ({ str }) => str ? import_react12.default.createElement("span", { className: styles_css_default9["filtering-match-highlight"] }, str) : null;
function HighlightMatch({ str, highlightText }) {
  if (!str || !highlightText) {
    return import_react12.default.createElement("span", null, str);
  }
  if (str === highlightText) {
    return import_react12.default.createElement(Highlight, { str });
  }
  const { noMatches, matches } = splitOnFiltering(str, highlightText);
  const highlighted = [];
  noMatches.forEach((noMatch, idx) => {
    highlighted.push(import_react12.default.createElement("span", { key: `noMatch-${idx}` }, noMatch));
    if (matches && idx < matches.length) {
      highlighted.push(import_react12.default.createElement(Highlight, { key: `match-${idx}`, str: matches[idx] }));
    }
  });
  return import_react12.default.createElement("span", null, highlighted);
}
...
// node_modules/@cloudscape-design/components/internal/components/option/option-parts.js
var Label = ({ label, prefix, highlightText, triggerVariant }) => import_react13.default.createElement(
  "span",
  { className: clsx_m_default(styles_css_default9.label, styles_css_default10.label, triggerVariant && styles_css_default9["trigger-variant"]) },
  prefix && import_react13.default.createElement(
    "span",
    { className: clsx_m_default(styles_css_default9["label-prefix"], triggerVariant && styles_css_default9["trigger-variant"]) },
    prefix,
    " "
  ),
  import_react13.default.createElement(HighlightMatch, { str: label, highlightText })
);
var LabelTag = ({ labelTag, highlightText, triggerVariant }) => labelTag ? import_react13.default.createElement(
  "span",
  { className: clsx_m_default(styles_css_default9["label-tag"], triggerVariant && styles_css_default9["trigger-variant"]) },
  import_react13.default.createElement(HighlightMatch, { str: labelTag, highlightText })
) : null;
var Description = ({ description, highlightedOption, highlightText, selectedOption, triggerVariant }) => description ? import_react13.default.createElement(
  "span",
  ...
  import_react13.default.createElement(HighlightMatch, { str: description, highlightText })
) : null;
var Tags = ({ tags, highlightedOption, highlightText, selectedOption, triggerVariant }) => tags ? import_react13.default.createElement("span", { className: clsx_m_default(styles_css_default9.tags, {
  [styles_css_default9.highlighted]: highlightedOption,
  [styles_css_default9.selected]: selectedOption
}) }, tags.map((tag, idx) => import_react13.default.createElement(
  "span",
  { key: idx, className: clsx_m_default(styles_css_default9.tag, triggerVariant && styles_css_default9["trigger-variant"]) },
  import_react13.default.createElement(HighlightMatch, { str: tag, highlightText })
))) : null;
var FilteringTags = ({ filteringTags, highlightedOption, highlightText, selectedOption, triggerVariant }) => {
  ...
  return import_react13.default.createElement("span", { className: clsx_m_default(styles_css_default9.tags, {
    [styles_css_default9.highlighted]: highlightedOption,
    [styles_css_default9.selected]: selectedOption
    ...
    if (match) {
      return import_react13.default.createElement(
        ...
        import_react13.default.createElement(HighlightMatch, { str: filteringTag, highlightText })
      );
    }
    return null;
  }));
...
var OptionIcon = (props2) => {
  ...
  return import_react13.default.createElement(
    ...
    import_react13.default.createElement(internal_default, Object.assign({}, props2))
  );
};
...
var Option = (_a) => {
  ...
  const icon = option.__customIcon || import_react14.default.createElement(OptionIcon, { name: option.iconName, url: option.iconUrl, svg: option.iconSvg, alt: option.iconAlt, size: option.description || option.tags ? "big" : "normal" });
  ...
  return import_react14.default.createElement(
    ...
    import_react14.default.createElement(
      ...
      import_react14.default.createElement(
        ...
        import_react14.default.createElement(Label, { label: (_e = option.label) !== null && _e !== void 0 ? _e : option.value, prefix: option.__labelPrefix, highlightText, triggerVariant }),
        import_react14.default.createElement(LabelTag, { labelTag: option.labelTag, highlightText, triggerVariant })
      ),
      import_react14.default.createElement(Description, { description: option.description, highlightedOption, selectedOption, highlightText, triggerVariant }),
      import_react14.default.createElement(Tags, { tags: option.tags, highlightedOption, selectedOption, highlightText, triggerVariant }),
      import_react14.default.createElement(FilteringTags, { filteringTags: option.filteringTags, highlightedOption, selectedOption, highlightText, triggerVariant })
    )
  );
};
...
var SelectableItem = (_a, ref) => {
  ...
  const classNames = clsx_m_default(className, styles_css_default12["selectable-item"], {
    ...
    [styles_css_default12.virtual]: virtualPosition !== void 0,
  ...
  const screenReaderContentRef = (0, import_react15.useRef)(null);
  ...
  return import_react15.default.createElement(
    ...
    import_react15.default.createElement("div", { className: clsx_m_default(styles_css_default12["option-content"], styles_css_default11["option-content"]), ref: contentRef }, content),
    import_react15.default.createElement("div", { className: styles_css_default12["measure-strut"], ref }),
    import_react15.default.createElement("div", { className: styles_css_default12["screenreader-content"], ref: screenReaderContentRef })
  );
};
var selectable_item_default = import_react15.default.forwardRef(SelectableItem);
...
var Item = (_a, ref) => {
  ...
  return import_react16.default.createElement(
    ...
    import_react16.default.createElement(
      ...
      hasCheckbox && !isParent && import_react16.default.createElement(
        "div",
        { className: styles_css_default7.checkbox },
        import_react16.default.createElement(checkbox_icon_default, { checked: selected || false, disabled: option.disabled })
      ),
      import_react16.default.createElement(option_default, { option: Object.assign(Object.assign({}, wrappedOption), { disabled }), highlightedOption: highlighted, selectedOption: selected, highlightText: filteringValue, isGroupOption: isParent }),
      !hasCheckbox && !isParent && selected && import_react16.default.createElement(
        "div",
        { className: styles_css_default7["selected-icon"] },
        import_react16.default.createElement(internal_default, { name: "check" })
      ),
      isDisabledWithReason && import_react16.default.createElement(
        import_react16.default.Fragment,
        null,
        descriptionEl,
        highlighted && import_react16.default.createElement(Tooltip, { className: styles_css_default7["disabled-reason-tooltip"], trackRef: internalRef, value: disabledReason, position: "right", hideOnOverscroll: true })
      )
    )
  );
};
var item_default = import_react16.default.memo(import_react16.default.forwardRef(Item));
...
var MultiSelectItem = (_a, ref) => {
  ...
  return import_react17.default.createElement(
    ...
    import_react17.default.createElement(
      "div",
      { className },
      hasCheckbox && import_react17.default.createElement(
        "div",
        { className: styles_css_default7.checkbox },
        import_react17.default.createElement(checkbox_icon_default, { checked: selected, indeterminate: isParent && indeterminate, disabled: option.disabled })
      ),
...
var multiselect_item_default = import_react17.default.memo(import_react17.default.forwardRef(MultiSelectItem));
...
var renderOptions = ({ options, getOptionProps, filteringValue, highlightType, checkboxes = false, hasDropdownStatus, virtualItems, useInteractiveGroups, screenReaderContent, ariaSetsize }) => {
  return options.map((option, index) => {
    ...
    return import_react18.default.createElement(ListItem, Object.assign({ key: globalIndex }, props2, { virtualPosition: virtualItem && virtualItem.start, ref: virtualItem && virtualItem.measureRef, padBottom, screenReaderContent, ariaPosinset: globalIndex + 1, ariaSetsize, highlightType: highlightType.type }));
  });
};
...
var PlainList = ({ menuProps, getOptionProps, filteredOptions, filteringValue, highlightType, checkboxes, hasDropdownStatus, listBottom, useInteractiveGroups, screenReaderContent }, ref) => {
  ...
  return import_react19.default.createElement(
    ...
    listBottom ? import_react19.default.createElement("li", { role: "option", className: styles_css_default7["list-bottom"] }, listBottom) : null
  );
};
var plain_list_default = (0, import_react19.forwardRef)(PlainList);
...
var ButtonTrigger = (_a, ref) => {
  ...
  const baseProps = getBaseProps(restProps);
  let attributes = Object.assign(Object.assign({}, baseProps), { type: "button", className: clsx_m_default(styles_css_default14["button-trigger"], styles_css_default13["button-trigger"], baseProps.className, pressed && styles_css_default14.pressed, disabled && styles_css_default14.disabled, invalid && styles_css_default14.invalid, warning && !invalid && styles_css_default14.warning, !hideCaret && styles_css_default14["has-caret"], readOnly && styles_css_default14.readonly, inFilteringToken && styles_css_default14["in-filtering-token"], inFilteringToken && styles_css_default14[`in-filtering-token-${inFilteringToken}`], inlineTokens && styles_css_default14["inline-tokens"]), disabled, "aria-expanded": pressed, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, "aria-describedby": ariaDescribedby, "aria-haspopup": ariaHasPopup !== null && ariaHasPopup !== void 0 ? ariaHasPopup : "listbox", "aria-controls": ariaControls, "aria-disabled": readOnly && !disabled ? "true" : void 0, autoFocus });
  if (!readOnly) {
  ...
  return import_react20.default.createElement(
    ...
    children,
    !hideCaret && import_react20.default.createElement(
      "span",
      { className: styles_css_default14.arrow },
      import_react20.default.createElement(internal_default, { name: "caret-down-filled", variant: disabled || readOnly ? "disabled" : "normal" })
    )
  );
};
var button_trigger_default = import_react20.default.forwardRef(ButtonTrigger);
...
// node_modules/@cloudscape-design/components/select/parts/trigger.js
var Trigger = import_react21.default.forwardRef(({ ariaLabelledby, ariaDescribedby, controlId, invalid, inlineLabelText, warning, triggerProps, selectedOption, selectedOptions, triggerVariant, inFilteringToken, isOpen, placeholder, disabled, readOnly }, ref) => {
  const isVisualRefresh = useVisualRefresh();
  ...
  if (triggerVariant === "tokens") {
    if (selectedOptions === null || selectedOptions === void 0 ? void 0 : selectedOptions.length) {
      triggerContent = import_react21.default.createElement(
        "span",
        ...
        import_react21.default.createElement("span", { className: styles_css_default7["inline-token-list"] }, selectedOptions.map(({ label }, i) => import_react21.default.createElement("span", { key: i, className: styles_css_default7["inline-token"] }, label))),
        import_react21.default.createElement(
          "span",
          { className: styles_css_default7["inline-token-counter"], id: triggerContentId },
          import_react21.default.createElement("span", { className: styles_css_default7["inline-token-hidden-placeholder"] }, placeholder),
          import_react21.default.createElement(
            "span",
            null,
            "(",
      ...
      triggerContent = import_react21.default.createElement("span", { "aria-disabled": "true", className: clsx_m_default(styles_css_default7.placeholder, styles_css_default7.trigger), id: triggerContentId }, placeholder);
    }
  } else if (!selectedOption) {
    triggerContent = import_react21.default.createElement("span", { "aria-disabled": "true", className: clsx_m_default(styles_css_default7.placeholder, styles_css_default7.trigger), id: triggerContentId }, placeholder);
  } else if (triggerVariant === "option") {
    triggerContent = import_react21.default.createElement(option_default, { id: triggerContentId, option: Object.assign(Object.assign({}, selectedOption), { disabled }), triggerVariant: true });
  } else {
    triggerContent = import_react21.default.createElement("span", { id: triggerContentId, className: styles_css_default7.trigger }, selectedOption.label || selectedOption.value);
  }
  const mergedRef = useMergeRefs(triggerProps.ref, ref);
  const triggerButton = import_react21.default.createElement(button_trigger_default, Object.assign({}, triggerProps, { id, ref: mergedRef, pressed: isOpen, disabled, readOnly, invalid, warning: warning && !invalid, inFilteringToken, inlineTokens: triggerVariant === "tokens", ariaDescribedby, ariaLabelledby: ariaLabelledbyIds }), triggerContent);
  return import_react21.default.createElement(import_react21.default.Fragment, null, inlineLabelText ? import_react21.default.createElement(
    "div",
    { className: styles_css_default7["inline-label-wrapper"] },
    import_react21.default.createElement("label", { htmlFor: controlId, className: clsx_m_default(styles_css_default7["inline-label"], disabled && styles_css_default7["inline-label-disabled"]) }, inlineLabelText),
    import_react21.default.createElement("div", { className: styles_css_default7["inline-label-trigger-wrapper"] }, triggerButton)
  ) : import_react21.default.createElement(import_react21.default.Fragment, null, triggerButton));
});
...
function useRect(nodeRef, initialRect) {
  ...
  var _React$useState = import_react22.default.useState(nodeRef.current), element = _React$useState[0], setElement = _React$useState[1];
  var _React$useReducer = import_react22.default.useReducer(rectReducer, initialRect), rect = _React$useReducer[0], dispatch = _React$useReducer[1];
  var initialRectSet = import_react22.default.useRef(false);
...
function useVirtual(_ref) {
  ...
  var latestRef = import_react22.default.useRef({
    scrollOffset: 0,
    measurements: []
  });
  var _React$useState = import_react22.default.useState(0), scrollOffset = _React$useState[0], setScrollOffset = _React$useState[1];
  latestRef.current.scrollOffset = scrollOffset;
  var useMeasureParent = useObserver || useRect;
  var _useMeasureParent = useMeasureParent(parentRef, initialRect), outerSize = _useMeasureParent[sizeKey];
  latestRef.current.outerSize = outerSize;
  var defaultScrollToFn = import_react22.default.useCallback(function(offset) {
    if (parentRef.current) {
      parentRef.current[scrollKey] = offset;
    }
  }, [parentRef, scrollKey]);
  var resolvedScrollToFn = scrollToFn || defaultScrollToFn;
  scrollToFn = import_react22.default.useCallback(function(offset) {
    resolvedScrollToFn(offset, defaultScrollToFn);
  }, [defaultScrollToFn, resolvedScrollToFn]);
  var _React$useState2 = import_react22.default.useState({}), measuredCache = _React$useState2[0], setMeasuredCache = _React$useState2[1];
  var measure = import_react22.default.useCallback(function() {
    return setMeasuredCache({});
  }, []);
  var pendingMeasuredCacheIndexesRef = import_react22.default.useRef([]);
  var measurements = import_react22.default.useMemo(function() {
  ...
  var scrollOffsetFnRef = import_react22.default.useRef(scrollOffsetFn);
  ...
  var indexes = import_react22.default.useMemo(function() {
  ...
  var measureSizeRef = import_react22.default.useRef(measureSize);
  measureSizeRef.current = measureSize;
  var virtualItems = import_react22.default.useMemo(function() {
    var virtualItems2 = [];
  ...
  var scrollToOffset = import_react22.default.useCallback(function(toOffset, _temp) {
  ...
  var tryScrollToIndex = import_react22.default.useCallback(function(index, _temp2) {
  ...
  var scrollToIndex = import_react22.default.useCallback(function() {
...
function useVirtual2({ items, parentRef, estimateSize }) {
  ...
  const measuresCache = (0, import_react23.useRef)(/* @__PURE__ */ new WeakMap());
  ...
  const virtualItems = (0, import_react23.useMemo)(() => rowVirtualizer.virtualItems.map((virtualItem) => Object.assign(Object.assign({}, virtualItem), { measureRef: (node) => {
    var _a;
...
var VirtualList = (props2, ref) => {
  return props2.menuProps.open ? import_react24.default.createElement(VirtualListOpen, Object.assign({}, props2, { ref })) : import_react24.default.createElement(VirtualListClosed, Object.assign({}, props2, { ref }));
};
var VirtualListOpen = (0, import_react24.forwardRef)(({ menuProps, getOptionProps, filteredOptions, filteringValue, highlightType, checkboxes, hasDropdownStatus, listBottom, useInteractiveGroups, screenReaderContent }, ref) => {
  const [width, menuMeasureRef] = useContainerQuery((rect) => rect.contentBoxWidth, []);
  const menuRefObject = (0, import_react24.useRef)(null);
  ...
  const { virtualItems, totalSize, scrollToIndex } = useVirtual2({
    ...
    estimateSize: (0, import_react24.useCallback)(() => 31, [width, filteringValue])
  });
  (0, import_react24.useImperativeHandle)(ref, () => (index) => {
  ...
  return import_react24.default.createElement(
    ...
    import_react24.default.createElement("div", { "aria-hidden": "true", key: "total-size", className: styles_css_default7["layout-strut"], style: { height: totalSize } }),
    finalOptions,
    listBottom ? import_react24.default.createElement("li", { role: "option", className: styles_css_default7["list-bottom"] }, listBottom) : null
  );
});
var VirtualListClosed = (0, import_react24.forwardRef)(({ menuProps, listBottom }, ref) => {
  (0, import_react24.useImperativeHandle)(ref, () => () => {
  }, []);
  return import_react24.default.createElement(options_list_default, Object.assign({}, menuProps, { ref: menuProps.ref }), listBottom ? import_react24.default.createElement("li", { role: "option", className: styles_css_default7["list-bottom"] }, listBottom) : null);
});
var virtual_list_default = (0, import_react24.forwardRef)(VirtualList);
...
function useAnnouncement({ announceSelected, highlightedOption, getParent, selectedAriaLabel, renderHighlightedAriaLive }) {
  const prevAnnouncedGroup = (0, import_react25.useRef)(void 0);
...
var useLoadItems = ({ onLoadItems, options, statusType }) => {
  const prevFilteringText = (0, import_react26.useRef)(void 0);
...
function useNativeSearch({ isEnabled, options, highlightOption, highlightedOption, useInteractiveGroups }) {
  const value = (0, import_react27.useRef)("");
...
function useHighlightedOption({ options, isHighlightable }) {
  const [highlightedIndex, setHighlightedIndexState] = (0, import_react28.useState)(-1);
  const [highlightType, setHighlightType] = (0, import_react28.useState)(new HighlightType("keyboard"));
  const setHighlightedIndex = (0, import_react28.useCallback)((index, newHighlightType) => {
  ...
  const highlightOption = (0, import_react28.useCallback)((option, highlightType2) => {
...
var useOpenState = ({ onOpen, onClose, defaultOpen = false }) => {
  const [isOpen, setIsOpen] = (0, import_react29.useState)(defaultOpen);
  const [openedWithKeyboard, setOpenedWithKeyboard] = (0, import_react29.useState)(false);
...
// node_modules/@cloudscape-design/components/select/internal.js
var InternalSelect = import_react31.default.forwardRef((_a, externalRef) => {
  var _b;
  ...
  const [filteringValue, setFilteringValue] = (0, import_react31.useState)("");
  ...
  const scrollToIndex = (0, import_react31.useRef)(null);
  ...
  const filter = import_react31.default.createElement(filter_default, Object.assign({ clearAriaLabel: filteringClearAriaLabel, filteringType, placeholder: filteringPlaceholder, ariaLabel: filteringAriaLabel, ariaRequired, value: filteringValue }, getFilterProps()));
  const trigger = import_react31.default.createElement(trigger_default, Object.assign({ ref: triggerRef, placeholder, disabled, readOnly, triggerVariant, triggerProps: getTriggerProps(disabled, autoFocus), selectedOption, isOpen, inFilteringToken: __inFilteringToken, inlineLabelText }, formFieldContext, { controlId, ariaLabelledby: joinStrings(formFieldContext.ariaLabelledby, selectAriaLabelId) }));
  ...
  return import_react31.default.createElement(
    "div",
    Object.assign({}, baseProps, { ref: mergedRef, className: clsx_m_default(styles_css_default15.root, baseProps.className), onKeyDown: handleNativeSearch }),
    import_react31.default.createElement(
      dropdown_default,
      Object.assign({}, dropdownProps, { ariaLabelledby: dropdownProps.dropdownContentRole ? joinStrings(selectAriaLabelId, controlId) : void 0, ariaDescribedby: dropdownProps.dropdownContentRole ? dropdownStatus.content ? footerId : void 0 : void 0, open: isOpen, stretchTriggerHeight: !!__inFilteringToken, stretchBeyondTriggerWidth: true, trigger, header: filter, onMouseDown: handleMouseDown, footer: dropdownStatus.isSticky ? import_react31.default.createElement(dropdown_footer_default, { content: isOpen ? dropdownStatus.content : null, id: footerId }) : null, expandToViewport }),
      import_react31.default.createElement(ListComponent, { listBottom: !dropdownStatus.isSticky ? import_react31.default.createElement(dropdown_footer_default, { content: isOpen ? dropdownStatus.content : null, id: footerId }) : null, menuProps, getOptionProps, filteredOptions, filteringValue, ref: scrollToIndex, hasDropdownStatus: dropdownStatus.content !== null, screenReaderContent: announcement, highlightType })
    ),
    import_react31.default.createElement("div", { hidden: true, id: selectAriaLabelId }, ariaLabel || inlineLabelText)
  );
});
var internal_default6 = InternalSelect;

// node_modules/@cloudscape-design/components/select/index.js
var Select = import_react32.default.forwardRef((_a, ref) => {
  ...
  const componentAnalyticsMetadata = {
    name: "awsui.Select",
    label: `.${styles_css_default13["button-trigger"]}`,
    properties: {
      disabled: `${!!externalProps.disabled}`
    }
  };
  return import_react32.default.createElement(internal_default6, Object.assign({ options, filteringType, statusType, triggerVariant }, externalProps, baseComponentProps, { ref }, getAnalyticsMetadataAttribute({ component: componentAnalyticsMetadata })));
});
...
export {
  ...
  generateTestIndexes,
  plain_list_default,
  styles_css_default13 as styles_css_default2,
...
//# sourceMappingURL=chunk-H2SB6BLF.js.map

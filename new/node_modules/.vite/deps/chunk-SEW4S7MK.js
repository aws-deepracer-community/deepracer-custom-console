...
// node_modules/@cloudscape-design/components/status-indicator/internal.js
var typeToIcon = (size) => ({
  error: import_react4.default.createElement(internal_default, { name: "status-negative", size }),
  warning: import_react4.default.createElement(internal_default, { name: "status-warning", size }),
  success: import_react4.default.createElement(internal_default, { name: "status-positive", size }),
  info: import_react4.default.createElement(internal_default, { name: "status-info", size }),
  stopped: import_react4.default.createElement(internal_default, { name: "status-stopped", size }),
  pending: import_react4.default.createElement(internal_default, { name: "status-pending", size }),
  "in-progress": import_react4.default.createElement(internal_default, { name: "status-in-progress", size }),
  loading: import_react4.default.createElement(InternalSpinner, null)
});
  ...
  return import_react4.default.createElement(
    ...
    import_react4.default.createElement(
      ...
      import_react4.default.createElement(
        ...
        __display === "inline" && import_react4.default.createElement(import_react4.default.Fragment, null, " ")
      ),
      children
    )
  );
...
function DropdownStatus({ children }) {
  return import_react6.default.createElement("div", { className: styles_css_default4.root }, children);
}
var useDropdownStatus = ({ statusType, empty, loadingText, finishedText, filteringResultsText, errorText, recoveryText, isEmpty, isNoMatch, isFiltered, noMatch, onRecoveryClick, hasRecoveryCallback = false, errorIconAriaLabel }) => {
  ...
  if (statusType === "loading") {
    statusResult.content = import_react6.default.createElement(StatusIndicator, { type: "loading" }, loadingText);
  } else if (statusType === "error") {
    statusResult.hasRecoveryButton = !!recoveryText && hasRecoveryCallback;
    statusResult.content = import_react6.default.createElement(
      "span",
      null,
      import_react6.default.createElement(StatusIndicator, { type: "error", __display: "inline", __animate: previousStatusType !== "error", iconAriaLabel: errorIconAriaLabel }, errorText),
      " ",
      statusResult.hasRecoveryButton && import_react6.default.createElement(internal_default4, { onFollow: () => fireNonCancelableEvent(onRecoveryClick), variant: "recovery", className: styles_css_default4.recovery }, recoveryText)
    );
...
// node_modules/@cloudscape-design/components/internal/components/dropdown-footer/index.js
var DropdownFooter = ({ content, id, hasItems = true }) => import_react7.default.createElement(
  "div",
  ...
  import_react7.default.createElement(internal_default2, { id }, content && import_react7.default.createElement(dropdown_status_default, null, content))
);
...
var FormFieldContext = (0, import_react8.createContext)({});
...
function useFormFieldContext(props2) {
  const context = (0, import_react8.useContext)(FormFieldContext);
...
var useSearchProps = (type, disabled, readOnly, value, inputRef, onChange) => {
  const searchProps = {};
  const handleIconClick = (0, import_react9.useCallback)(() => {
    var _a;
...
function InternalInput(_a, ref) {
  ...
  return import_react10.default.createElement(
    ...
    __leftIcon && import_react10.default.createElement(
      "span",
      { onClick: __onLeftIconClick, className: styles_css_default6["input-icon-left"] },
      import_react10.default.createElement(internal_default, { name: __leftIcon, variant: disabled || readOnly ? "disabled" : __leftIconVariant })
    ),
    import_react10.default.createElement("input", Object.assign({ ref: mergedRef }, attributes)),
    __rightIcon && import_react10.default.createElement(
      "span",
...
var internal_default5 = import_react10.default.forwardRef(InternalInput);
...
var options_list_default = import_react12.default.forwardRef(OptionsList);
...
var CheckboxIcon = (_a) => {
  ...
  return import_react13.default.createElement(
    ...
    import_react13.default.createElement("rect", { className: clsx_m_default(styles_css_default9["styled-box"], {
    ...
    checked || indeterminate ? import_react13.default.createElement("polyline", { className: clsx_m_default(styles_css_default9["styled-line"], {
...
var Highlight = ({ str }) => str ? import_react14.default.createElement("span", { className: styles_css_default10["filtering-match-highlight"] }, str) : null;
function HighlightMatch({ str, highlightText }) {
  if (!str || !highlightText) {
    return import_react14.default.createElement("span", null, str);
  }
  if (str === highlightText) {
    return import_react14.default.createElement(Highlight, { str });
  }
  const { noMatches, matches } = splitOnFiltering(str, highlightText);
  const highlighted = [];
  noMatches.forEach((noMatch, idx) => {
    highlighted.push(import_react14.default.createElement("span", { key: `noMatch-${idx}` }, noMatch));
    if (matches && idx < matches.length) {
      highlighted.push(import_react14.default.createElement(Highlight, { key: `match-${idx}`, str: matches[idx] }));
    }
  });
  return import_react14.default.createElement("span", null, highlighted);
}
...
// node_modules/@cloudscape-design/components/internal/components/option/option-parts.js
var Label = ({ label, prefix, highlightText, triggerVariant }) => import_react15.default.createElement(
  "span",
  ...
  prefix && import_react15.default.createElement(
    "span",
    { className: clsx_m_default(styles_css_default10["label-prefix"], triggerVariant && styles_css_default10["trigger-variant"]) },
    prefix,
    " "
  ),
  import_react15.default.createElement(HighlightMatch, { str: label, highlightText })
);
var LabelTag = ({ labelTag, highlightText, triggerVariant }) => labelTag ? import_react15.default.createElement(
  "span",
  { className: clsx_m_default(styles_css_default10["label-tag"], triggerVariant && styles_css_default10["trigger-variant"]) },
  import_react15.default.createElement(HighlightMatch, { str: labelTag, highlightText })
) : null;
var Description = ({ description, highlightedOption, highlightText, selectedOption, triggerVariant }) => description ? import_react15.default.createElement(
  "span",
  ...
  import_react15.default.createElement(HighlightMatch, { str: description, highlightText })
) : null;
var Tags = ({ tags, highlightedOption, highlightText, selectedOption, triggerVariant }) => tags ? import_react15.default.createElement("span", { className: clsx_m_default(styles_css_default10.tags, {
  [styles_css_default10.highlighted]: highlightedOption,
  [styles_css_default10.selected]: selectedOption
}) }, tags.map((tag, idx) => import_react15.default.createElement(
  "span",
  { key: idx, className: clsx_m_default(styles_css_default10.tag, triggerVariant && styles_css_default10["trigger-variant"]) },
  import_react15.default.createElement(HighlightMatch, { str: tag, highlightText })
))) : null;
var FilteringTags = ({ filteringTags, highlightedOption, highlightText, selectedOption, triggerVariant }) => {
  ...
  return import_react15.default.createElement("span", { className: clsx_m_default(styles_css_default10.tags, {
    [styles_css_default10.highlighted]: highlightedOption,
    [styles_css_default10.selected]: selectedOption
    ...
    if (match) {
      return import_react15.default.createElement(
        ...
        import_react15.default.createElement(HighlightMatch, { str: filteringTag, highlightText })
      );
    }
    return null;
  }));
...
var OptionIcon = (props2) => {
  ...
  return import_react15.default.createElement(
    ...
    import_react15.default.createElement(internal_default, Object.assign({}, props2))
  );
};
...
var Option = (_a) => {
  ...
  const icon = option.__customIcon || import_react16.default.createElement(OptionIcon, { name: option.iconName, url: option.iconUrl, svg: option.iconSvg, alt: option.iconAlt, size: option.description || option.tags ? "big" : "normal" });
  ...
  return import_react16.default.createElement(
    ...
    import_react16.default.createElement(
      ...
      import_react16.default.createElement(
        ...
        import_react16.default.createElement(Label, { label: (_e = option.label) !== null && _e !== void 0 ? _e : option.value, prefix: option.__labelPrefix, highlightText, triggerVariant }),
        import_react16.default.createElement(LabelTag, { labelTag: option.labelTag, highlightText, triggerVariant })
      ),
      import_react16.default.createElement(Description, { description: option.description, highlightedOption, selectedOption, highlightText, triggerVariant }),
      import_react16.default.createElement(Tags, { tags: option.tags, highlightedOption, selectedOption, highlightText, triggerVariant }),
      import_react16.default.createElement(FilteringTags, { filteringTags: option.filteringTags, highlightedOption, selectedOption, highlightText, triggerVariant })
    )
  );
};
...
var SelectableItem = (_a, ref) => {
  ...
  const screenReaderContentRef = (0, import_react17.useRef)(null);
  ...
  return import_react17.default.createElement(
    ...
    import_react17.default.createElement("div", { className: clsx_m_default(styles_css_default13["option-content"], styles_css_default12["option-content"]), ref: contentRef }, content),
    import_react17.default.createElement("div", { className: styles_css_default13["measure-strut"], ref }),
    import_react17.default.createElement("div", { className: styles_css_default13["screenreader-content"], ref: screenReaderContentRef })
  );
};
var selectable_item_default = import_react17.default.forwardRef(SelectableItem);
...
var Item = (_a, ref) => {
  ...
  return import_react18.default.createElement(
    ...
    import_react18.default.createElement(
      ...
      hasCheckbox && !isParent && import_react18.default.createElement(
        "div",
        { className: styles_css_default7.checkbox },
        import_react18.default.createElement(checkbox_icon_default, { checked: selected || false, disabled: option.disabled })
      ),
      import_react18.default.createElement(option_default, { option: Object.assign(Object.assign({}, wrappedOption), { disabled }), highlightedOption: highlighted, selectedOption: selected, highlightText: filteringValue, isGroupOption: isParent }),
      !hasCheckbox && !isParent && selected && import_react18.default.createElement(
        "div",
        { className: styles_css_default7["selected-icon"] },
        import_react18.default.createElement(internal_default, { name: "check" })
      ),
      isDisabledWithReason && import_react18.default.createElement(
        import_react18.default.Fragment,
        null,
        descriptionEl,
        highlighted && import_react18.default.createElement(Tooltip, { className: styles_css_default7["disabled-reason-tooltip"], trackRef: internalRef, value: disabledReason, position: "right", hideOnOverscroll: true })
      )
    )
  );
};
var item_default = import_react18.default.memo(import_react18.default.forwardRef(Item));
...
var MultiSelectItem = (_a, ref) => {
  ...
  return import_react19.default.createElement(
    ...
    import_react19.default.createElement(
      "div",
      { className },
      hasCheckbox && import_react19.default.createElement(
        "div",
        { className: styles_css_default7.checkbox },
        import_react19.default.createElement(checkbox_icon_default, { checked: selected, indeterminate: isParent && indeterminate, disabled: option.disabled })
      ),
...
var multiselect_item_default = import_react19.default.memo(import_react19.default.forwardRef(MultiSelectItem));
...
var renderOptions = ({ options, getOptionProps, filteringValue, highlightType, checkboxes = false, hasDropdownStatus, virtualItems, useInteractiveGroups, screenReaderContent, ariaSetsize }) => {
  return options.map((option, index) => {
    ...
    return import_react20.default.createElement(ListItem, Object.assign({ key: globalIndex }, props2, { virtualPosition: virtualItem && virtualItem.start, ref: virtualItem && virtualItem.measureRef, padBottom, screenReaderContent, ariaPosinset: globalIndex + 1, ariaSetsize, highlightType: highlightType.type }));
  });
};
...
var PlainList = ({ menuProps, getOptionProps, filteredOptions, filteringValue, highlightType, checkboxes, hasDropdownStatus, listBottom, useInteractiveGroups, screenReaderContent }, ref) => {
  ...
  return import_react21.default.createElement(
    ...
    listBottom ? import_react21.default.createElement("li", { role: "option", className: styles_css_default7["list-bottom"] }, listBottom) : null
  );
};
var plain_list_default = (0, import_react21.forwardRef)(PlainList);
...
var ButtonTrigger = (_a, ref) => {
  ...
  return import_react22.default.createElement(
    ...
    children,
    !hideCaret && import_react22.default.createElement(
      "span",
      { className: styles_css_default15.arrow },
      import_react22.default.createElement(internal_default, { name: "caret-down-filled", variant: disabled || readOnly ? "disabled" : "normal" })
    )
  );
};
var button_trigger_default = import_react22.default.forwardRef(ButtonTrigger);
...
// node_modules/@cloudscape-design/components/select/parts/trigger.js
var Trigger = import_react23.default.forwardRef(({ ariaLabelledby, ariaDescribedby, controlId, invalid, inlineLabelText, warning, triggerProps, selectedOption, selectedOptions, triggerVariant, inFilteringToken, isOpen, placeholder, disabled, readOnly }, ref) => {
  const isVisualRefresh = useVisualRefresh();
  ...
  if (triggerVariant === "tokens") {
    if (selectedOptions === null || selectedOptions === void 0 ? void 0 : selectedOptions.length) {
      triggerContent = import_react23.default.createElement(
        "span",
        ...
        import_react23.default.createElement("span", { className: styles_css_default7["inline-token-list"] }, selectedOptions.map(({ label }, i) => import_react23.default.createElement("span", { key: i, className: styles_css_default7["inline-token"] }, label))),
        import_react23.default.createElement(
          "span",
          { className: styles_css_default7["inline-token-counter"], id: triggerContentId },
          import_react23.default.createElement("span", { className: styles_css_default7["inline-token-hidden-placeholder"] }, placeholder),
          import_react23.default.createElement(
            "span",
            null,
            "(",
      ...
      triggerContent = import_react23.default.createElement("span", { "aria-disabled": "true", className: clsx_m_default(styles_css_default7.placeholder, styles_css_default7.trigger), id: triggerContentId }, placeholder);
    }
  } else if (!selectedOption) {
    triggerContent = import_react23.default.createElement("span", { "aria-disabled": "true", className: clsx_m_default(styles_css_default7.placeholder, styles_css_default7.trigger), id: triggerContentId }, placeholder);
  } else if (triggerVariant === "option") {
    triggerContent = import_react23.default.createElement(option_default, { id: triggerContentId, option: Object.assign(Object.assign({}, selectedOption), { disabled }), triggerVariant: true });
  } else {
    triggerContent = import_react23.default.createElement("span", { id: triggerContentId, className: styles_css_default7.trigger }, selectedOption.label || selectedOption.value);
  }
  const mergedRef = useMergeRefs(triggerProps.ref, ref);
  const triggerButton = import_react23.default.createElement(button_trigger_default, Object.assign({}, triggerProps, { id, ref: mergedRef, pressed: isOpen, disabled, readOnly, invalid, warning: warning && !invalid, inFilteringToken, inlineTokens: triggerVariant === "tokens", ariaDescribedby, ariaLabelledby: ariaLabelledbyIds }), triggerContent);
  return import_react23.default.createElement(import_react23.default.Fragment, null, inlineLabelText ? import_react23.default.createElement(
    "div",
    { className: styles_css_default7["inline-label-wrapper"] },
    import_react23.default.createElement("label", { htmlFor: controlId, className: clsx_m_default(styles_css_default7["inline-label"], disabled && styles_css_default7["inline-label-disabled"]) }, inlineLabelText),
    import_react23.default.createElement("div", { className: styles_css_default7["inline-label-trigger-wrapper"] }, triggerButton)
  ) : import_react23.default.createElement(import_react23.default.Fragment, null, triggerButton));
});
...
function useRect(nodeRef, initialRect) {
  ...
  var _React$useState = import_react24.default.useState(nodeRef.current), element = _React$useState[0], setElement = _React$useState[1];
  var _React$useReducer = import_react24.default.useReducer(rectReducer, initialRect), rect = _React$useReducer[0], dispatch = _React$useReducer[1];
  var initialRectSet = import_react24.default.useRef(false);
...
function useVirtual(_ref) {
  ...
  var latestRef = import_react24.default.useRef({
    scrollOffset: 0,
    measurements: []
  });
  var _React$useState = import_react24.default.useState(0), scrollOffset = _React$useState[0], setScrollOffset = _React$useState[1];
  latestRef.current.scrollOffset = scrollOffset;
  var useMeasureParent = useObserver || useRect;
  var _useMeasureParent = useMeasureParent(parentRef, initialRect), outerSize = _useMeasureParent[sizeKey];
  latestRef.current.outerSize = outerSize;
  var defaultScrollToFn = import_react24.default.useCallback(function(offset) {
    if (parentRef.current) {
      parentRef.current[scrollKey] = offset;
    }
  }, [parentRef, scrollKey]);
  var resolvedScrollToFn = scrollToFn || defaultScrollToFn;
  scrollToFn = import_react24.default.useCallback(function(offset) {
    resolvedScrollToFn(offset, defaultScrollToFn);
  }, [defaultScrollToFn, resolvedScrollToFn]);
  var _React$useState2 = import_react24.default.useState({}), measuredCache = _React$useState2[0], setMeasuredCache = _React$useState2[1];
  var measure = import_react24.default.useCallback(function() {
    return setMeasuredCache({});
  }, []);
  var pendingMeasuredCacheIndexesRef = import_react24.default.useRef([]);
  var measurements = import_react24.default.useMemo(function() {
  ...
  var scrollOffsetFnRef = import_react24.default.useRef(scrollOffsetFn);
  ...
  var indexes = import_react24.default.useMemo(function() {
  ...
  var measureSizeRef = import_react24.default.useRef(measureSize);
  measureSizeRef.current = measureSize;
  var virtualItems = import_react24.default.useMemo(function() {
    var virtualItems2 = [];
  ...
  var mountedRef = import_react24.default.useRef(false);
  useIsomorphicLayoutEffect(function() {
  ...
  var scrollToOffset = import_react24.default.useCallback(function(toOffset, _temp) {
  ...
  var tryScrollToIndex = import_react24.default.useCallback(function(index, _temp2) {
  ...
  var scrollToIndex = import_react24.default.useCallback(function() {
...
function useVirtual2({ items, parentRef, estimateSize }) {
  ...
  const measuresCache = (0, import_react25.useRef)(/* @__PURE__ */ new WeakMap());
  ...
  const virtualItems = (0, import_react25.useMemo)(() => rowVirtualizer.virtualItems.map((virtualItem) => Object.assign(Object.assign({}, virtualItem), { measureRef: (node) => {
    var _a;
...
var VirtualList = (props2, ref) => {
  return props2.menuProps.open ? import_react26.default.createElement(VirtualListOpen, Object.assign({}, props2, { ref })) : import_react26.default.createElement(VirtualListClosed, Object.assign({}, props2, { ref }));
};
var VirtualListOpen = (0, import_react26.forwardRef)(({ menuProps, getOptionProps, filteredOptions, filteringValue, highlightType, checkboxes, hasDropdownStatus, listBottom, useInteractiveGroups, screenReaderContent }, ref) => {
  const [width, menuMeasureRef] = useContainerQuery((rect) => rect.contentBoxWidth, []);
  const menuRefObject = (0, import_react26.useRef)(null);
  ...
  const { virtualItems, totalSize, scrollToIndex } = useVirtual2({
    ...
    estimateSize: (0, import_react26.useCallback)(() => 31, [width, filteringValue])
  });
  (0, import_react26.useImperativeHandle)(ref, () => (index) => {
  ...
  return import_react26.default.createElement(
    ...
    import_react26.default.createElement("div", { "aria-hidden": "true", key: "total-size", className: styles_css_default7["layout-strut"], style: { height: totalSize } }),
    finalOptions,
    listBottom ? import_react26.default.createElement("li", { role: "option", className: styles_css_default7["list-bottom"] }, listBottom) : null
  );
});
var VirtualListClosed = (0, import_react26.forwardRef)(({ menuProps, listBottom }, ref) => {
  (0, import_react26.useImperativeHandle)(ref, () => () => {
  }, []);
  return import_react26.default.createElement(options_list_default, Object.assign({}, menuProps, { ref: menuProps.ref }), listBottom ? import_react26.default.createElement("li", { role: "option", className: styles_css_default7["list-bottom"] }, listBottom) : null);
});
var virtual_list_default = (0, import_react26.forwardRef)(VirtualList);
...
function useAnnouncement({ announceSelected, highlightedOption, getParent, selectedAriaLabel, renderHighlightedAriaLive }) {
  const prevAnnouncedGroup = (0, import_react27.useRef)(void 0);
...
var useLoadItems = ({ onLoadItems, options, statusType }) => {
  const prevFilteringText = (0, import_react28.useRef)(void 0);
...
function useNativeSearch({ isEnabled, options, highlightOption, highlightedOption, useInteractiveGroups }) {
  const value = (0, import_react29.useRef)("");
...
function useHighlightedOption({ options, isHighlightable }) {
  ...
  const setHighlightedIndex = (0, import_react30.useCallback)((index, newHighlightType) => {
...
function useSelect({ selectedOptions, updateSelectedOption, options, filteringType, onBlur, onFocus, externalRef, keepOpen, embedded, fireLoadItems, setFilteringValue, useInteractiveGroups = false, statusType }) {
  ...
  const filterRef = (0, import_react32.useRef)(null);
...
// node_modules/@cloudscape-design/components/select/internal.js
var InternalSelect = import_react33.default.forwardRef((_a, externalRef) => {
  var _b;
  ...
  const [filteringValue, setFilteringValue] = (0, import_react33.useState)("");
  ...
  const scrollToIndex = (0, import_react33.useRef)(null);
  ...
  const filter = import_react33.default.createElement(filter_default, Object.assign({ clearAriaLabel: filteringClearAriaLabel, filteringType, placeholder: filteringPlaceholder, ariaLabel: filteringAriaLabel, ariaRequired, value: filteringValue }, getFilterProps()));
  const trigger = import_react33.default.createElement(trigger_default, Object.assign({ ref: triggerRef, placeholder, disabled, readOnly, triggerVariant, triggerProps: getTriggerProps(disabled, autoFocus), selectedOption, isOpen, inFilteringToken: __inFilteringToken, inlineLabelText }, formFieldContext, { controlId, ariaLabelledby: joinStrings(formFieldContext.ariaLabelledby, selectAriaLabelId) }));
  ...
  return import_react33.default.createElement(
    ...
    import_react33.default.createElement(
      dropdown_default,
      Object.assign({}, dropdownProps, { ariaLabelledby: dropdownProps.dropdownContentRole ? joinStrings(selectAriaLabelId, controlId) : void 0, ariaDescribedby: dropdownProps.dropdownContentRole ? dropdownStatus.content ? footerId : void 0 : void 0, open: isOpen, stretchTriggerHeight: !!__inFilteringToken, stretchBeyondTriggerWidth: true, trigger, header: filter, onMouseDown: handleMouseDown, footer: dropdownStatus.isSticky ? import_react33.default.createElement(dropdown_footer_default, { content: isOpen ? dropdownStatus.content : null, id: footerId }) : null, expandToViewport }),
      import_react33.default.createElement(ListComponent, { listBottom: !dropdownStatus.isSticky ? import_react33.default.createElement(dropdown_footer_default, { content: isOpen ? dropdownStatus.content : null, id: footerId }) : null, menuProps, getOptionProps, filteredOptions, filteringValue, ref: scrollToIndex, hasDropdownStatus: dropdownStatus.content !== null, screenReaderContent: announcement, highlightType })
    ),
    import_react33.default.createElement("div", { hidden: true, id: selectAriaLabelId }, ariaLabel || inlineLabelText)
  );
});
var internal_default6 = InternalSelect;

// node_modules/@cloudscape-design/components/select/index.js
var Select = import_react34.default.forwardRef((_a, ref) => {
  ...
  return import_react34.default.createElement(internal_default6, Object.assign({ options, filteringType, statusType, triggerVariant }, externalProps, baseComponentProps, { ref }, getAnalyticsMetadataAttribute({ component: componentAnalyticsMetadata })));
});
...
//# sourceMappingURL=chunk-SEW4S7MK.js.map

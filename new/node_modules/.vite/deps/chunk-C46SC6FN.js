...
var InternalIcon = (_a) => {
  ...
  if (svg) {
    ...
    return import_react3.default.createElement("span", Object.assign({}, baseProps, { ref: mergedRef, "aria-hidden": "true", style: inlineStyles }), svg);
  }
  if (url) {
    return import_react3.default.createElement(
      "span",
      Object.assign({}, baseProps, { ref: mergedRef, style: inlineStyles }),
      import_react3.default.createElement("img", { src: url, alt })
    );
  }
  ...
  return import_react3.default.createElement("span", Object.assign({}, baseProps, { ref: mergedRef, style: inlineStyles }), validIcon ? iconMap(name) : void 0);
};
...
var Arrow = (props) => {
  ...
  return import_react4.default.createElement(
    "div",
    { className: clsx_m_default(styles_css_default2.arrow, props.position && styles_css_default2[`arrow-position-${props.position}`]) },
    import_react4.default.createElement("div", { className: styles_css_default2["arrow-outer"] }),
    import_react4.default.createElement("div", { className: clsx_m_default(styles_css_default2["arrow-inner"], isVisualRefresh && styles_css_default2.refresh) })
  );
};
var arrow_default = import_react4.default.memo(Arrow);
...
function TabTrap({ focusNextCallback, disabled = false }) {
  return import_react5.default.createElement("div", { className: styles_css_default3.root, tabIndex: disabled ? -1 : 0, onFocus: focusNextCallback });
}
...
function FocusLock({ className, disabled, autoFocus, restoreFocus, children: children2 }, ref) {
  const returnFocusToRef = (0, import_react6.useRef)(null);
  ...
  const [previouslyDisabled, setPreviouslyDisabled] = (0, import_react6.useState)(!!disabled);
  (0, import_react6.useEffect)(() => {
    var _a;
  ...
  const restoreFocusHandler = (0, import_react6.useCallback)((elem) => {
    var _a;
  ...
  (0, import_react6.useImperativeHandle)(ref, () => ({ focusFirst }));
  const mergedRef = useMergeRefs(containerRef, restoreFocusHandler);
  return import_react6.default.createElement(
    import_react6.default.Fragment,
    null,
    import_react6.default.createElement(TabTrap, { disabled, focusNextCallback: focusLast }),
    import_react6.default.createElement("div", { className, ref: mergedRef }, children2),
    import_react6.default.createElement(TabTrap, { disabled, focusNextCallback: focusFirst })
  );
}
var focus_lock_default = import_react6.default.forwardRef(FocusLock);
...
function PopoverBody({ dismissButton: showDismissButton, dismissAriaLabel, header, children: children2, onDismiss, variant, overflowVisible, className, ariaLabelledby, closeAnalyticsAction }) {
  ...
  const dismissButtonFocused = (0, import_react7.useRef)(false);
  const dismissButtonRef = (0, import_react7.useRef)(null);
  ...
  const dismissButton = (showDismissButton !== null && showDismissButton !== void 0 ? showDismissButton : null) && import_react7.default.createElement(
    "div",
    ...
    import_react7.default.createElement(InternalButton, { variant: "icon", formAction: "none", iconName: "close", className: styles_css_default2["dismiss-control"], ariaLabel: i18n("dismissAriaLabel", dismissAriaLabel), onClick: () => onDismiss === null || onDismiss === void 0 ? void 0 : onDismiss(), ref: dismissButtonRef })
  );
  ...
  return import_react7.default.createElement(
    "div",
    Object.assign({ className: clsx_m_default(styles_css_default2.body, className, {
    ...
    import_react7.default.createElement(
      ...
      import_react7.default.createElement(
        ...
        import_react7.default.createElement("div", { className: clsx_m_default(styles_css_default2.content, { [styles_css_default2["content-overflow-visible"]]: !!overflowVisible }) }, children2)
      )
    )
  );
}
...
function usePopoverPosition({ popoverRef, bodyRef, arrowRef, trackRef, contentRef, allowScrollToFit, allowVerticalOverflow, preferredPosition, renderWithPortal, keepPosition, hideOnOverscroll }) {
  const previousInternalPositionRef = (0, import_react8.useRef)(null);
  const [popoverStyle, setPopoverStyle] = (0, import_react8.useState)({});
  const [internalPosition, setInternalPosition] = (0, import_react8.useState)(null);
  const [isOverscrolling, setIsOverscrolling] = (0, import_react8.useState)(false);
  const positionHandlerRef = (0, import_react8.useRef)(() => {
  });
  const scrollableContainerRectRef = (0, import_react8.useRef)(null);
  const updatePositionHandler = (0, import_react8.useCallback)((onContentResize = false) => {
    var _a;
...
function PopoverContainer({ position, trackRef, trackKey, arrow, children: children2, zIndex, renderWithPortal, size, fixedWidth, variant, keepPosition, allowScrollToFit, allowVerticalOverflow, hideOnOverscroll }) {
  ...
  return isOverscrolling ? null : import_react9.default.createElement(
    "div",
    { ref: popoverRef, style: Object.assign(Object.assign({}, popoverStyle), { zIndex }), className: clsx_m_default(styles_css_default2.container, isRefresh && styles_css_default2.refresh) },
    import_react9.default.createElement("div", { ref: arrowRef, className: clsx_m_default(styles_css_default2[`container-arrow`], styles_css_default2[`container-arrow-position-${internalPosition}`]), "aria-hidden": true }, arrow(internalPosition)),
    import_react9.default.createElement(
      "div",
      { ref: bodyRef, className: clsx_m_default(styles_css_default2["container-body"], styles_css_default2[`container-body-size-${size}`], {
        [styles_css_default2["fixed-width"]]: fixedWidth,
        [styles_css_default2[`container-body-variant-${variant}`]]: variant
      }) },
      import_react9.default.createElement("div", { ref: contentRef }, children2)
    )
  );
}
...
var TransitionGroup = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react15.default.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, import_react15.default.createElement(Component, props, children2));
  };
...
function Tooltip({ value, trackRef, trackKey, className, contentAttributes = {}, position = "top", size = "small", hideOnOverscroll }) {
  ...
  return import_react20.default.createElement(
    ...
    import_react20.default.createElement(
      "div",
      Object.assign({ className: clsx_m_default(styles_css_default4.root, className) }, contentAttributes, { "data-testid": trackKey }),
      import_react20.default.createElement(Transition2, { in: true }, () => import_react20.default.createElement(
        PopoverContainer,
        { trackRef, trackKey, size, fixedWidth: false, position, zIndex: 7e3, arrow: (position2) => import_react20.default.createElement(arrow_default, { position: position2 }), hideOnOverscroll },
...
var ButtonContext = (0, import_react21.createContext)({
  onClick: () => {
  }
});
function useButtonContext() {
  return (0, import_react21.useContext)(ButtonContext);
}
...
var SingleTabStopNavigationContext = (0, import_react22.createContext)(defaultValue);
function useSingleTabStopNavigation(focusable, options) {
  var _a;
  const { navigationActive: contextNavigationActive, registerFocusable } = (0, import_react22.useContext)(SingleTabStopNavigationContext);
  const [focusTargetActive, setFocusTargetActive] = (0, import_react22.useState)(false);
...
var SingleTabStopNavigationProvider = (0, import_react22.forwardRef)(({ navigationActive, children: children2, getNextFocusTarget, isElementSuppressed, onRegisterFocusable, onUnregisterActive }, ref) => {
  const focusables = (0, import_react22.useRef)(/* @__PURE__ */ new Set());
  const focusHandlers = (0, import_react22.useRef)(/* @__PURE__ */ new Map());
  const focusablesState = (0, import_react22.useRef)(/* @__PURE__ */ new WeakMap());
  const focusTarget = (0, import_react22.useRef)(null);
  ...
  (0, import_react22.useImperativeHandle)(ref, () => ({ updateFocusTarget, getFocusTarget, isRegistered }));
  return import_react22.default.createElement(SingleTabStopNavigationContext.Provider, { value: { navigationActive, registerFocusable } }, children2);
});
...
function useForwardFocus(mainRef, controlRef) {
  (0, import_react23.useImperativeHandle)(mainRef, () => ({
    focus(...args) {
      var _a;
...
function useHiddenDescription(description) {
  ...
  return {
    ...
    descriptionEl: description ? import_react24.default.createElement("span", { id, hidden: true }, description) : null,
    descriptionId: id
  };
}
...
function useDOMAttribute(elementRef, attributeName, value) {
  const attributeValueRef = (0, import_react26.useRef)();
...
var useEvaluateComponentVisibility = () => {
  const [evaluateComponentVisibility, setEvaluateComponentVisibility] = (0, import_react28.useState)(false);
...
// node_modules/@cloudscape-design/components/live-region/internal.js
var internal_default2 = import_react29.default.forwardRef(function InternalLiveRegion(_a, ref) {
  ...
  const childrenRef = (0, import_react29.useRef)(null);
  ...
  const liveRegionControllerRef = (0, import_react29.useRef)();
  (0, import_react29.useEffect)(() => {
  ...
  return import_react29.default.createElement(TagName, Object.assign({ ref: mergedRef }, baseProps, { className: clsx_m_default(styles_css_default5.root, styles_css_default6.root, className), hidden }), children2);
});
...
function InternalSpinner(_a) {
  ...
  return import_react30.default.createElement(
    ...
    import_react30.default.createElement("span", { className: clsx_m_default(styles_css_default7.circle, styles_css_default7["circle-left"]) }),
    import_react30.default.createElement("span", { className: clsx_m_default(styles_css_default7.circle, styles_css_default7["circle-right"]) })
  );
}
...
function IconWrapper(_a) {
  ...
  return React21.createElement(internal_default, { className: clsx_m_default(styles_css_default8.icon, styles_css_default8[`icon-${getIconAlign(props)}`], props.iconClass), name: iconName, url: iconUrl, svg: iconSvg, alt: iconAlt, size: iconSize, badge });
}
function LeftIcon(props) {
  if (props.loading) {
    return React21.createElement(InternalSpinner, { className: clsx_m_default(styles_css_default8.icon, styles_css_default8["icon-left"]) });
  } else if (getIconAlign(props) === "left") {
    return React21.createElement(IconWrapper, Object.assign({}, props));
  }
  return null;
}
...
// node_modules/@cloudscape-design/components/button/internal.js
var InternalButton = import_react31.default.forwardRef((_a, ref) => {
  ...
  const [showTooltip, setShowTooltip] = (0, import_react31.useState)(false);
  ...
  const buttonContent = import_react31.default.createElement(
    import_react31.default.Fragment,
    null,
    import_react31.default.createElement(LeftIcon, Object.assign({}, iconProps)),
    shouldHaveContent && import_react31.default.createElement(
      import_react31.default.Fragment,
      null,
      import_react31.default.createElement("span", { className: clsx_m_default(styles_css_default8.content, styles_css_default9.label) }, children2),
      external && import_react31.default.createElement(
        import_react31.default.Fragment,
        null,
        " ",
        import_react31.default.createElement(
          ...
          import_react31.default.createElement(internal_default, { name: "external", className: styles_css_default10["external-icon"] })
        )
      )
    ),
    import_react31.default.createElement(RightIcon, Object.assign({}, iconProps))
  );
  ...
  const disabledReasonContent = import_react31.default.createElement(
    import_react31.default.Fragment,
    null,
    descriptionEl,
    showTooltip && import_react31.default.createElement(Tooltip, { className: styles_css_default10["disabled-reason-tooltip"], trackRef: buttonRef, value: disabledReason })
  );
  if (isAnchor) {
    return (
      ...
      import_react31.default.createElement(
        ...
        loading && loadingText && import_react31.default.createElement(internal_default2, { tagName: "span", hidden: true }, loadingText)
      )
    );
  }
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-C46SC6FN.js.map

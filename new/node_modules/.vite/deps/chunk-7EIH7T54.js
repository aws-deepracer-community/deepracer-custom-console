...
function useDOMAttribute(elementRef, attributeName, value) {
  const attributeValueRef = (0, import_react24.useRef)();
...
function useEffectOnUpdate(callback, deps) {
  const isFirstRender = (0, import_react25.useRef)(true);
...
var useEvaluateComponentVisibility = () => {
  const [evaluateComponentVisibility, setEvaluateComponentVisibility] = (0, import_react26.useState)(false);
...
// node_modules/@cloudscape-design/components/live-region/internal.js
var internal_default2 = import_react27.default.forwardRef(function InternalLiveRegion(_a, ref) {
  ...
  const liveRegionControllerRef = (0, import_react27.useRef)();
  (0, import_react27.useEffect)(() => {
  ...
  return import_react27.default.createElement(TagName, Object.assign({ ref: mergedRef }, baseProps, { className: clsx_m_default(styles_css_default5.root, styles_css_default6.root, className), hidden }), children2);
});
...
function IconWrapper(_a) {
  ...
  return React20.createElement(internal_default, { className: clsx_m_default(styles_css_default8.icon, styles_css_default8[`icon-${getIconAlign(props)}`], props.iconClass), name: iconName, url: iconUrl, svg: iconSvg, alt: iconAlt, size: iconSize, badge });
}
    ...
    shouldHaveContent && import_react29.default.createElement(
      ...
      external && import_react29.default.createElement(
        ...
        import_react29.default.createElement(
          ...
          import_react29.default.createElement(internal_default, { name: "external", className: styles_css_default10["external-icon"] })
        )
      )
    ),
  ...
  if (isAnchor) {
    return (
      ...
      import_react29.default.createElement(
        ...
        loading && loadingText && import_react29.default.createElement(internal_default2, { tagName: "span", hidden: true }, loadingText)
      )
    );
  }
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-7EIH7T54.js.map

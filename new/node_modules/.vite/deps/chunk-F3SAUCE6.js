import {
  getExternalProps,
  useDebounceCallback
} from "./chunk-F4CZFT2Y.js";
import {
  useMobile
} from "./chunk-6TSI3OEO.js";
import {
...
// node_modules/@cloudscape-design/components/link/internal.js
var InternalLink = import_react4.default.forwardRef((_a, ref) => {
  ...
  const isButton = !href;
  const { defaultVariant } = (0, import_react4.useContext)(LinkDefaultVariantContext);
  ...
  const infoLinkLabelFromContext = (0, import_react4.useContext)(InfoLinkLabelContext);
  ...
  const linkRef = (0, import_react4.useRef)(null);
  ...
  const content = import_react4.default.createElement(
    ...
    null,
    children,
    external && import_react4.default.createElement(
      "span",
      ...
      import_react4.default.createElement(
        ...
        import_react4.default.createElement(internal_default, { name: "external", size: "inherit" })
      )
    ),
    variant === "info" && import_react4.default.createElement("span", { hidden: true, id: infoId }, ":")
  );
  const { tabIndex } = useSingleTabStopNavigation(linkRef, { tabIndex: isButton ? 0 : void 0 });
  if (isButton) {
    return import_react4.default.createElement("a", Object.assign({}, sharedProps, { role: "button", tabIndex, onKeyDown: handleButtonKeyDown, onClick: handleButtonClick }), content);
  }
  return (
    // we dynamically set proper rel in the code above
    // eslint-disable-next-line react/jsx-no-target-blank
    import_react4.default.createElement("a", Object.assign({}, sharedProps, { tabIndex, target: anchorTarget, rel: anchorRel, href, onClick: handleLinkClick }), content)
  );
});
...
// node_modules/@cloudscape-design/components/status-indicator/internal.js
var typeToIcon = (size) => ({
  error: import_react5.default.createElement(internal_default, { name: "status-negative", size }),
  warning: import_react5.default.createElement(internal_default, { name: "status-warning", size }),
  success: import_react5.default.createElement(internal_default, { name: "status-positive", size }),
  info: import_react5.default.createElement(internal_default, { name: "status-info", size }),
  stopped: import_react5.default.createElement(internal_default, { name: "status-stopped", size }),
  pending: import_react5.default.createElement(internal_default, { name: "status-pending", size }),
  "in-progress": import_react5.default.createElement(internal_default, { name: "status-in-progress", size }),
  loading: import_react5.default.createElement(InternalSpinner, null)
});
function StatusIndicator(_a) {
  ...
  return import_react5.default.createElement(
    "span",
    Object.assign({}, baseProps, { className: clsx_m_default(styles_css_default3.root, styles_css_default3[`status-${type}`], {
      [styles_css_default3[`color-override-${colorOverride}`]]: colorOverride
    }, baseProps.className), ref: __internalRootRef }),
    import_react5.default.createElement(
      "span",
      { className: clsx_m_default(styles_css_default3.container, styles_css_default3[`display-${__display}`], wrapText === false && styles_css_default3["overflow-ellipsis"], __animate && styles_css_default3["container-fade-in"]) },
      import_react5.default.createElement(
        "span",
        { className: clsx_m_default(styles_css_default3.icon, __animate && styles_css_default3["icon-shake"]), "aria-label": iconAriaLabel, role: iconAriaLabel ? "img" : void 0 },
        typeToIcon(__size)[type],
        __display === "inline" && import_react5.default.createElement(import_react5.default.Fragment, null, " ")
      ),
      children
    )
  );
...
function DropdownStatus({ children }) {
  return import_react7.default.createElement("div", { className: styles_css_default4.root }, children);
}
var useDropdownStatus = ({ statusType, empty, loadingText, finishedText, filteringResultsText, errorText, recoveryText, isEmpty, isNoMatch, isFiltered, noMatch, onRecoveryClick, hasRecoveryCallback = false, errorIconAriaLabel }) => {
  ...
  if (statusType === "loading") {
    statusResult.content = import_react7.default.createElement(StatusIndicator, { type: "loading" }, loadingText);
  } else if (statusType === "error") {
    statusResult.hasRecoveryButton = !!recoveryText && hasRecoveryCallback;
    statusResult.content = import_react7.default.createElement(
      "span",
      null,
      import_react7.default.createElement(StatusIndicator, { type: "error", __display: "inline", __animate: previousStatusType !== "error", iconAriaLabel: errorIconAriaLabel }, errorText),
      " ",
      statusResult.hasRecoveryButton && import_react7.default.createElement(internal_default4, { onFollow: () => fireNonCancelableEvent(onRecoveryClick), variant: "recovery", className: styles_css_default4.recovery }, recoveryText)
    );
...
// node_modules/@cloudscape-design/components/internal/components/dropdown-footer/index.js
var DropdownFooter = ({ content, id, hasItems = true }) => import_react8.default.createElement(
  "div",
  { className: clsx_m_default(styles_css_default5.root, { [styles_css_default5.hidden]: content === null, [styles_css_default5["no-items"]]: !hasItems }) },
  import_react8.default.createElement(internal_default2, { id }, content && import_react8.default.createElement(dropdown_status_default, null, content))
);
...
var FormFieldContext = (0, import_react9.createContext)({});
...
function useFormFieldContext(props2) {
  const context = (0, import_react9.useContext)(FormFieldContext);
...
var useSearchProps = (type, disabled, readOnly, value, inputRef, onChange) => {
  const searchProps = {};
  const handleIconClick = (0, import_react10.useCallback)(() => {
    var _a;
...
var styles_css_default6 = {
  "root": "awsui_root_2rhyz_1hz2o_145",
  "input": "awsui_input_2rhyz_1hz2o_149",
  "input-readonly": "awsui_input-readonly_2rhyz_1hz2o_196",
  "input-invalid": "awsui_input-invalid_2rhyz_1hz2o_263",
  "input-has-icon-left": "awsui_input-has-icon-left_2rhyz_1hz2o_272",
  "input-warning": "awsui_input-warning_2rhyz_1hz2o_275",
  "input-type-search": "awsui_input-type-search_2rhyz_1hz2o_287",
  "input-has-icon-right": "awsui_input-has-icon-right_2rhyz_1hz2o_300",
  "input-has-no-border-radius": "awsui_input-has-no-border-radius_2rhyz_1hz2o_303",
  "input-container": "awsui_input-container_2rhyz_1hz2o_310",
  "input-icon-left": "awsui_input-icon-left_2rhyz_1hz2o_315",
  "input-icon-right": "awsui_input-icon-right_2rhyz_1hz2o_322",
  "input-button-right": "awsui_input-button-right_2rhyz_1hz2o_328"
};
...
function InternalInput(_a, ref) {
  ...
  const attributes = Object.assign({
    ...
    className: clsx_m_default(styles_css_default6.input, type && styles_css_default6[`input-type-${type}`], __rightIcon && styles_css_default6["input-has-icon-right"], __leftIcon && styles_css_default6["input-has-icon-left"], __noBorderRadius && styles_css_default6["input-has-no-border-radius"], {
      ...
      [styles_css_default6["input-warning"]]: warning && !invalid
    }),
  ...
  return import_react11.default.createElement(
    "div",
    Object.assign({}, baseProps, { className: clsx_m_default(baseProps.className, styles_css_default6["input-container"]), ref: __internalRootRef, dir: type === "email" ? "ltr" : void 0 }),
    __leftIcon && import_react11.default.createElement(
      "span",
      { onClick: __onLeftIconClick, className: styles_css_default6["input-icon-left"] },
      import_react11.default.createElement(internal_default, { name: __leftIcon, variant: disabled || readOnly ? "disabled" : __leftIconVariant })
    ),
    import_react11.default.createElement("input", Object.assign({ ref: mergedRef }, attributes)),
    __rightIcon && import_react11.default.createElement(
      "span",
      Object.assign({ className: styles_css_default6["input-icon-right"] }, __rightIcon === "close" ? getAnalyticsMetadataAttribute({
        action: "clearInput"
      }) : {}),
...
var internal_default5 = import_react11.default.forwardRef(InternalInput);
...
var CheckboxIcon = (_a) => {
  ...
  return import_react14.default.createElement(
    "svg",
    Object.assign({ className: styles_css_default9.root, viewBox: dimensions.viewBox, "aria-hidden": "true", focusable: "false" }, baseProps),
    import_react14.default.createElement("rect", { className: clsx_m_default(styles_css_default9["styled-box"], {
      [styles_css_default9["styled-box-checked"]]: checked,
      [styles_css_default9["styled-box-indeterminate"]]: indeterminate,
      [styles_css_default9["styled-box-disabled"]]: disabled,
      [styles_css_default9["styled-box-readonly"]]: readOnly
    }), x: dimensions.xy, y: dimensions.xy, rx: dimensions.r, ry: dimensions.r, width: dimensions.size, height: dimensions.size }),
    checked || indeterminate ? import_react14.default.createElement("polyline", { className: clsx_m_default(styles_css_default9["styled-line"], {
      [styles_css_default9["styled-line-disabled"]]: disabled,
      [styles_css_default9["styled-line-readonly"]]: readOnly
...
var Highlight = ({ str }) => str ? import_react15.default.createElement("span", { className: styles_css_default10["filtering-match-highlight"] }, str) : null;
function HighlightMatch({ str, highlightText }) {
  if (!str || !highlightText) {
    return import_react15.default.createElement("span", null, str);
  }
  if (str === highlightText) {
    return import_react15.default.createElement(Highlight, { str });
  }
  const { noMatches, matches } = splitOnFiltering(str, highlightText);
  const highlighted = [];
  noMatches.forEach((noMatch, idx) => {
    highlighted.push(import_react15.default.createElement("span", { key: `noMatch-${idx}` }, noMatch));
    if (matches && idx < matches.length) {
      highlighted.push(import_react15.default.createElement(Highlight, { key: `match-${idx}`, str: matches[idx] }));
    }
  });
  return import_react15.default.createElement("span", null, highlighted);
}
...
// node_modules/@cloudscape-design/components/internal/components/option/option-parts.js
var Label = ({ label, prefix, highlightText, triggerVariant }) => import_react16.default.createElement(
  "span",
  { className: clsx_m_default(styles_css_default10.label, styles_css_default11.label, triggerVariant && styles_css_default10["trigger-variant"]) },
  prefix && import_react16.default.createElement(
    "span",
    { className: clsx_m_default(styles_css_default10["label-prefix"], triggerVariant && styles_css_default10["trigger-variant"]) },
    prefix,
    " "
  ),
  import_react16.default.createElement(HighlightMatch, { str: label, highlightText })
);
var LabelTag = ({ labelTag, highlightText, triggerVariant }) => labelTag ? import_react16.default.createElement(
  "span",
  { className: clsx_m_default(styles_css_default10["label-tag"], triggerVariant && styles_css_default10["trigger-variant"]) },
  import_react16.default.createElement(HighlightMatch, { str: labelTag, highlightText })
) : null;
var Description = ({ description, highlightedOption, highlightText, selectedOption, triggerVariant }) => description ? import_react16.default.createElement(
  "span",
  { className: clsx_m_default(styles_css_default10.description, {
    [styles_css_default10["trigger-variant"]]: triggerVariant,
    [styles_css_default10.highlighted]: highlightedOption,
    [styles_css_default10.selected]: selectedOption
  }) },
  import_react16.default.createElement(HighlightMatch, { str: description, highlightText })
) : null;
var Tags = ({ tags, highlightedOption, highlightText, selectedOption, triggerVariant }) => tags ? import_react16.default.createElement("span", { className: clsx_m_default(styles_css_default10.tags, {
  [styles_css_default10.highlighted]: highlightedOption,
  [styles_css_default10.selected]: selectedOption
}) }, tags.map((tag, idx) => import_react16.default.createElement(
  "span",
  { key: idx, className: clsx_m_default(styles_css_default10.tag, triggerVariant && styles_css_default10["trigger-variant"]) },
  import_react16.default.createElement(HighlightMatch, { str: tag, highlightText })
))) : null;
var FilteringTags = ({ filteringTags, highlightedOption, highlightText, selectedOption, triggerVariant }) => {
  ...
  return import_react16.default.createElement("span", { className: clsx_m_default(styles_css_default10.tags, {
    [styles_css_default10.highlighted]: highlightedOption,
    [styles_css_default10.selected]: selectedOption
    ...
    if (match) {
      return import_react16.default.createElement(
        "span",
        { className: clsx_m_default(styles_css_default10.tag, triggerVariant && styles_css_default10["trigger-variant"]), key, "aria-disabled": true },
        import_react16.default.createElement(HighlightMatch, { str: filteringTag, highlightText })
      );
    }
    return null;
  }));
...
var OptionIcon = (props2) => {
  ...
  return import_react16.default.createElement(
    "span",
    { className: clsx_m_default(styles_css_default10.icon, props2.size === "big" && [styles_css_default10[`icon-size-big`]]) },
    import_react16.default.createElement(internal_default, Object.assign({}, props2))
  );
};
...
var Option = (_a) => {
  ...
  const className = clsx_m_default(styles_css_default10.option, disabled && styles_css_default10.disabled, isGroupOption && styles_css_default10.parent, highlightedOption && styles_css_default10.highlighted);
  const icon = option.__customIcon || import_react17.default.createElement(OptionIcon, { name: option.iconName, url: option.iconUrl, svg: option.iconSvg, alt: option.iconAlt, size: option.description || option.tags ? "big" : "normal" });
  ...
  return import_react17.default.createElement(
    ...
    import_react17.default.createElement(
      "span",
      { className: styles_css_default10.content },
      import_react17.default.createElement(
        "span",
        { className: styles_css_default10["label-content"] },
        import_react17.default.createElement(Label, { label: (_e = option.label) !== null && _e !== void 0 ? _e : option.value, prefix: option.__labelPrefix, highlightText, triggerVariant }),
        import_react17.default.createElement(LabelTag, { labelTag: option.labelTag, highlightText, triggerVariant })
      ),
      import_react17.default.createElement(Description, { description: option.description, highlightedOption, selectedOption, highlightText, triggerVariant }),
      import_react17.default.createElement(Tags, { tags: option.tags, highlightedOption, selectedOption, highlightText, triggerVariant }),
      import_react17.default.createElement(FilteringTags, { filteringTags: option.filteringTags, highlightedOption, selectedOption, highlightText, triggerVariant })
    )
  );
};
...
var getAnalyticsSelectActionMetadata = (_a) => {
  ...
  const analyticsMetadata = {
    ...
    detail: {
      label: {
        selector: [`.${styles_css_default11.label}`, `.${styles_css_default12["option-content"]}`]
      }
    }
  };
  let position = void 0;
  ...
  if (isChild) {
    analyticsMetadata.detail.groupLabel = {
      root: "body",
      selector: `.${styles_css_default12.parent}[data-group-index="${dataAttributes["data-group-index"]}"] .${styles_css_default12["option-content"]}`
    };
  }
...
var SelectableItem = (_a, ref) => {
  ...
  const classNames = clsx_m_default(className, styles_css_default13["selectable-item"], {
    [styles_css_default13.selected]: selected,
    [styles_css_default13.highlighted]: highlighted,
    [styles_css_default13["has-background"]]: hasBackground,
    [styles_css_default13.parent]: isParent,
    [styles_css_default12.parent]: isParent,
    [styles_css_default13.child]: isChild,
    [styles_css_default13["is-keyboard"]]: highlightType === "keyboard",
    [styles_css_default13.disabled]: disabled,
    [styles_css_default13.virtual]: virtualPosition !== void 0,
    [styles_css_default13["pad-bottom"]]: padBottom,
    [styles_css_default13["next-item-selected"]]: isNextSelected,
    [styles_css_default13.interactiveGroups]: useInteractiveGroups
  });
  const contentRef = (0, import_react18.useRef)(null);
  const screenReaderContentRef = (0, import_react18.useRef)(null);
  ...
  return import_react18.default.createElement(
    ...
    import_react18.default.createElement("div", { className: clsx_m_default(styles_css_default13["option-content"], styles_css_default12["option-content"]), ref: contentRef }, content),
    import_react18.default.createElement("div", { className: styles_css_default13["measure-strut"], ref }),
    import_react18.default.createElement("div", { className: styles_css_default13["screenreader-content"], ref: screenReaderContentRef })
  );
};
var selectable_item_default = import_react18.default.forwardRef(SelectableItem);
...
var Item = (_a, ref) => {
  ...
  return import_react19.default.createElement(
    ...
    import_react19.default.createElement(
      ...
      hasCheckbox && !isParent && import_react19.default.createElement(
        "div",
        { className: styles_css_default7.checkbox },
        import_react19.default.createElement(checkbox_icon_default, { checked: selected || false, disabled: option.disabled })
      ),
      import_react19.default.createElement(option_default, { option: Object.assign(Object.assign({}, wrappedOption), { disabled }), highlightedOption: highlighted, selectedOption: selected, highlightText: filteringValue, isGroupOption: isParent }),
      !hasCheckbox && !isParent && selected && import_react19.default.createElement(
        "div",
        { className: styles_css_default7["selected-icon"] },
        import_react19.default.createElement(internal_default, { name: "check" })
      ),
      isDisabledWithReason && import_react19.default.createElement(
        import_react19.default.Fragment,
        null,
        descriptionEl,
        highlighted && import_react19.default.createElement(Tooltip, { className: styles_css_default7["disabled-reason-tooltip"], trackRef: internalRef, value: disabledReason, position: "right", hideOnOverscroll: true })
      )
    )
  );
};
var item_default = import_react19.default.memo(import_react19.default.forwardRef(Item));
...
var MultiSelectItem = (_a, ref) => {
  ...
  return import_react20.default.createElement(
    ...
    import_react20.default.createElement(
      "div",
      { className },
      hasCheckbox && import_react20.default.createElement(
        "div",
        { className: styles_css_default7.checkbox },
        import_react20.default.createElement(checkbox_icon_default, { checked: selected, indeterminate: isParent && indeterminate, disabled: option.disabled })
      ),
      import_react20.default.createElement(option_default, { option: Object.assign(Object.assign({}, wrappedOption), { disabled }), highlightedOption: highlighted, selectedOption: selected, highlightText: filteringValue, isGroupOption: isParent })
    ),
    isDisabledWithReason && import_react20.default.createElement(
      import_react20.default.Fragment,
      null,
      descriptionEl,
      highlighted && import_react20.default.createElement(Tooltip, { className: styles_css_default7["disabled-reason-tooltip"], trackRef: internalRef, value: disabledReason, position: "right", hideOnOverscroll: true })
    )
  );
};
var multiselect_item_default = import_react20.default.memo(import_react20.default.forwardRef(MultiSelectItem));
...
var renderOptions = ({ options, getOptionProps, filteringValue, highlightType, checkboxes = false, hasDropdownStatus, virtualItems, useInteractiveGroups, screenReaderContent, ariaSetsize }) => {
  return options.map((option, index) => {
    ...
    return import_react21.default.createElement(ListItem, Object.assign({ key: globalIndex }, props2, { virtualPosition: virtualItem && virtualItem.start, ref: virtualItem && virtualItem.measureRef, padBottom, screenReaderContent, ariaPosinset: globalIndex + 1, ariaSetsize, highlightType: highlightType.type }));
  });
};
...
var PlainList = ({ menuProps, getOptionProps, filteredOptions, filteringValue, highlightType, checkboxes, hasDropdownStatus, listBottom, useInteractiveGroups, screenReaderContent }, ref) => {
  ...
  (0, import_react22.useImperativeHandle)(ref, () => (index) => {
    var _a;
  ...
  return import_react22.default.createElement(
    ...
    listBottom ? import_react22.default.createElement("li", { role: "option", className: styles_css_default7["list-bottom"] }, listBottom) : null
  );
};
var plain_list_default = (0, import_react22.forwardRef)(PlainList);
...
var ButtonTrigger = (_a, ref) => {
  ...
  const baseProps = getBaseProps(restProps);
  let attributes = Object.assign(Object.assign({}, baseProps), { type: "button", className: clsx_m_default(styles_css_default15["button-trigger"], styles_css_default14["button-trigger"], baseProps.className, pressed && styles_css_default15.pressed, disabled && styles_css_default15.disabled, invalid && styles_css_default15.invalid, warning && !invalid && styles_css_default15.warning, !hideCaret && styles_css_default15["has-caret"], readOnly && styles_css_default15.readonly, inFilteringToken && styles_css_default15["in-filtering-token"], inFilteringToken && styles_css_default15[`in-filtering-token-${inFilteringToken}`], inlineTokens && styles_css_default15["inline-tokens"]), disabled, "aria-expanded": pressed, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, "aria-describedby": ariaDescribedby, "aria-haspopup": ariaHasPopup !== null && ariaHasPopup !== void 0 ? ariaHasPopup : "listbox", "aria-controls": ariaControls, "aria-disabled": readOnly && !disabled ? "true" : void 0, autoFocus });
  if (!readOnly) {
  ...
  return import_react23.default.createElement(
    ...
    children,
    !hideCaret && import_react23.default.createElement(
      "span",
      { className: styles_css_default15.arrow },
      import_react23.default.createElement(internal_default, { name: "caret-down-filled", variant: disabled || readOnly ? "disabled" : "normal" })
    )
  );
};
var button_trigger_default = import_react23.default.forwardRef(ButtonTrigger);
...
// node_modules/@cloudscape-design/components/select/parts/trigger.js
var Trigger = import_react24.default.forwardRef(({ ariaLabelledby, ariaDescribedby, controlId, invalid, inlineLabelText, warning, triggerProps, selectedOption, selectedOptions, triggerVariant, inFilteringToken, isOpen, placeholder, disabled, readOnly }, ref) => {
  const isVisualRefresh = useVisualRefresh();
  ...
  if (triggerVariant === "tokens") {
    if (selectedOptions === null || selectedOptions === void 0 ? void 0 : selectedOptions.length) {
      triggerContent = import_react24.default.createElement(
        "span",
        ...
        import_react24.default.createElement("span", { className: styles_css_default7["inline-token-list"] }, selectedOptions.map(({ label }, i) => import_react24.default.createElement("span", { key: i, className: styles_css_default7["inline-token"] }, label))),
        import_react24.default.createElement(
          "span",
          { className: styles_css_default7["inline-token-counter"], id: triggerContentId },
          import_react24.default.createElement("span", { className: styles_css_default7["inline-token-hidden-placeholder"] }, placeholder),
          import_react24.default.createElement(
            "span",
            null,
            "(",
      ...
      triggerContent = import_react24.default.createElement("span", { "aria-disabled": "true", className: clsx_m_default(styles_css_default7.placeholder, styles_css_default7.trigger), id: triggerContentId }, placeholder);
    }
  } else if (!selectedOption) {
    triggerContent = import_react24.default.createElement("span", { "aria-disabled": "true", className: clsx_m_default(styles_css_default7.placeholder, styles_css_default7.trigger), id: triggerContentId }, placeholder);
  } else if (triggerVariant === "option") {
    triggerContent = import_react24.default.createElement(option_default, { id: triggerContentId, option: Object.assign(Object.assign({}, selectedOption), { disabled }), triggerVariant: true });
  } else {
    triggerContent = import_react24.default.createElement("span", { id: triggerContentId, className: styles_css_default7.trigger }, selectedOption.label || selectedOption.value);
  }
  const mergedRef = useMergeRefs(triggerProps.ref, ref);
  const triggerButton = import_react24.default.createElement(button_trigger_default, Object.assign({}, triggerProps, { id, ref: mergedRef, pressed: isOpen, disabled, readOnly, invalid, warning: warning && !invalid, inFilteringToken, inlineTokens: triggerVariant === "tokens", ariaDescribedby, ariaLabelledby: ariaLabelledbyIds }), triggerContent);
  return import_react24.default.createElement(import_react24.default.Fragment, null, inlineLabelText ? import_react24.default.createElement(
    "div",
    { className: styles_css_default7["inline-label-wrapper"] },
    import_react24.default.createElement("label", { htmlFor: controlId, className: clsx_m_default(styles_css_default7["inline-label"], disabled && styles_css_default7["inline-label-disabled"]) }, inlineLabelText),
    import_react24.default.createElement("div", { className: styles_css_default7["inline-label-trigger-wrapper"] }, triggerButton)
  ) : import_react24.default.createElement(import_react24.default.Fragment, null, triggerButton));
});
...
function useRect(nodeRef, initialRect) {
  ...
  var _React$useState = import_react25.default.useState(nodeRef.current), element = _React$useState[0], setElement = _React$useState[1];
  var _React$useReducer = import_react25.default.useReducer(rectReducer, initialRect), rect = _React$useReducer[0], dispatch = _React$useReducer[1];
  var initialRectSet = import_react25.default.useRef(false);
...
function useVirtual(_ref) {
  ...
  var latestRef = import_react25.default.useRef({
    scrollOffset: 0,
    measurements: []
  });
  var _React$useState = import_react25.default.useState(0), scrollOffset = _React$useState[0], setScrollOffset = _React$useState[1];
  latestRef.current.scrollOffset = scrollOffset;
  var useMeasureParent = useObserver || useRect;
  var _useMeasureParent = useMeasureParent(parentRef, initialRect), outerSize = _useMeasureParent[sizeKey];
  latestRef.current.outerSize = outerSize;
  var defaultScrollToFn = import_react25.default.useCallback(function(offset) {
    if (parentRef.current) {
      parentRef.current[scrollKey] = offset;
    }
  }, [parentRef, scrollKey]);
  var resolvedScrollToFn = scrollToFn || defaultScrollToFn;
  scrollToFn = import_react25.default.useCallback(function(offset) {
    resolvedScrollToFn(offset, defaultScrollToFn);
  }, [defaultScrollToFn, resolvedScrollToFn]);
  var _React$useState2 = import_react25.default.useState({}), measuredCache = _React$useState2[0], setMeasuredCache = _React$useState2[1];
  var measure = import_react25.default.useCallback(function() {
    return setMeasuredCache({});
  }, []);
  var pendingMeasuredCacheIndexesRef = import_react25.default.useRef([]);
  var measurements = import_react25.default.useMemo(function() {
  ...
  var scrollOffsetFnRef = import_react25.default.useRef(scrollOffsetFn);
  ...
  var indexes = import_react25.default.useMemo(function() {
  ...
  var measureSizeRef = import_react25.default.useRef(measureSize);
  measureSizeRef.current = measureSize;
  var virtualItems = import_react25.default.useMemo(function() {
    var virtualItems2 = [];
  ...
  var mountedRef = import_react25.default.useRef(false);
  useIsomorphicLayoutEffect(function() {
  ...
  var scrollToOffset = import_react25.default.useCallback(function(toOffset, _temp) {
  ...
  var tryScrollToIndex = import_react25.default.useCallback(function(index, _temp2) {
  ...
  var scrollToIndex = import_react25.default.useCallback(function() {
...
function useVirtual2({ items, parentRef, estimateSize }) {
  ...
  const measuresCache = (0, import_react26.useRef)(/* @__PURE__ */ new WeakMap());
  ...
  const virtualItems = (0, import_react26.useMemo)(() => rowVirtualizer.virtualItems.map((virtualItem) => Object.assign(Object.assign({}, virtualItem), { measureRef: (node) => {
    var _a;
...
var VirtualList = (props2, ref) => {
  return props2.menuProps.open ? import_react27.default.createElement(VirtualListOpen, Object.assign({}, props2, { ref })) : import_react27.default.createElement(VirtualListClosed, Object.assign({}, props2, { ref }));
};
var VirtualListOpen = (0, import_react27.forwardRef)(({ menuProps, getOptionProps, filteredOptions, filteringValue, highlightType, checkboxes, hasDropdownStatus, listBottom, useInteractiveGroups, screenReaderContent }, ref) => {
  const [width, menuMeasureRef] = useContainerQuery((rect) => rect.contentBoxWidth, []);
  const menuRefObject = (0, import_react27.useRef)(null);
  ...
  const { virtualItems, totalSize, scrollToIndex } = useVirtual2({
    ...
    estimateSize: (0, import_react27.useCallback)(() => 31, [width, filteringValue])
  });
  ...
  return import_react27.default.createElement(
    ...
    import_react27.default.createElement("div", { "aria-hidden": "true", key: "total-size", className: styles_css_default7["layout-strut"], style: { height: totalSize } }),
    finalOptions,
    listBottom ? import_react27.default.createElement("li", { role: "option", className: styles_css_default7["list-bottom"] }, listBottom) : null
  );
});
var VirtualListClosed = (0, import_react27.forwardRef)(({ menuProps, listBottom }, ref) => {
  (0, import_react27.useImperativeHandle)(ref, () => () => {
  }, []);
  return import_react27.default.createElement(options_list_default, Object.assign({}, menuProps, { ref: menuProps.ref }), listBottom ? import_react27.default.createElement("li", { role: "option", className: styles_css_default7["list-bottom"] }, listBottom) : null);
});
var virtual_list_default = (0, import_react27.forwardRef)(VirtualList);
...
function useAnnouncement({ announceSelected, highlightedOption, getParent, selectedAriaLabel, renderHighlightedAriaLive }) {
  const prevAnnouncedGroup = (0, import_react28.useRef)(void 0);
...
var useLoadItems = ({ onLoadItems, options, statusType }) => {
  const prevFilteringText = (0, import_react29.useRef)(void 0);
...
function useNativeSearch({ isEnabled, options, highlightOption, highlightedOption, useInteractiveGroups }) {
  const value = (0, import_react30.useRef)("");
...
function useHighlightedOption({ options, isHighlightable }) {
  const [highlightedIndex, setHighlightedIndexState] = (0, import_react31.useState)(-1);
  const [highlightType, setHighlightType] = (0, import_react31.useState)(new HighlightType("keyboard"));
  const setHighlightedIndex = (0, import_react31.useCallback)((index, newHighlightType) => {
  ...
  const highlightOption = (0, import_react31.useCallback)((option, highlightType2) => {
...
var useOpenState = ({ onOpen, onClose, defaultOpen = false }) => {
  ...
  const [openedWithKeyboard, setOpenedWithKeyboard] = (0, import_react32.useState)(false);
...
// node_modules/@cloudscape-design/components/select/internal.js
var InternalSelect = import_react34.default.forwardRef((_a, externalRef) => {
  var _b;
  ...
  const [filteringValue, setFilteringValue] = (0, import_react34.useState)("");
  ...
  const scrollToIndex = (0, import_react34.useRef)(null);
  ...
  const filter = import_react34.default.createElement(filter_default, Object.assign({ clearAriaLabel: filteringClearAriaLabel, filteringType, placeholder: filteringPlaceholder, ariaLabel: filteringAriaLabel, ariaRequired, value: filteringValue }, getFilterProps()));
  const trigger = import_react34.default.createElement(trigger_default, Object.assign({ ref: triggerRef, placeholder, disabled, readOnly, triggerVariant, triggerProps: getTriggerProps(disabled, autoFocus), selectedOption, isOpen, inFilteringToken: __inFilteringToken, inlineLabelText }, formFieldContext, { controlId, ariaLabelledby: joinStrings(formFieldContext.ariaLabelledby, selectAriaLabelId) }));
  ...
  return import_react34.default.createElement(
    "div",
    Object.assign({}, baseProps, { ref: mergedRef, className: clsx_m_default(styles_css_default16.root, baseProps.className), onKeyDown: handleNativeSearch }),
    import_react34.default.createElement(
      dropdown_default,
      Object.assign({}, dropdownProps, { ariaLabelledby: dropdownProps.dropdownContentRole ? joinStrings(selectAriaLabelId, controlId) : void 0, ariaDescribedby: dropdownProps.dropdownContentRole ? dropdownStatus.content ? footerId : void 0 : void 0, open: isOpen, stretchTriggerHeight: !!__inFilteringToken, stretchBeyondTriggerWidth: true, trigger, header: filter, onMouseDown: handleMouseDown, footer: dropdownStatus.isSticky ? import_react34.default.createElement(dropdown_footer_default, { content: isOpen ? dropdownStatus.content : null, id: footerId }) : null, expandToViewport }),
      import_react34.default.createElement(ListComponent, { listBottom: !dropdownStatus.isSticky ? import_react34.default.createElement(dropdown_footer_default, { content: isOpen ? dropdownStatus.content : null, id: footerId }) : null, menuProps, getOptionProps, filteredOptions, filteringValue, ref: scrollToIndex, hasDropdownStatus: dropdownStatus.content !== null, screenReaderContent: announcement, highlightType })
    ),
    import_react34.default.createElement("div", { hidden: true, id: selectAriaLabelId }, ariaLabel || inlineLabelText)
  );
});
var internal_default6 = InternalSelect;

// node_modules/@cloudscape-design/components/select/index.js
var Select = import_react35.default.forwardRef((_a, ref) => {
  ...
  const componentAnalyticsMetadata = {
    name: "awsui.Select",
    label: `.${styles_css_default14["button-trigger"]}`,
    properties: {
      disabled: `${!!externalProps.disabled}`
    }
  };
  return import_react35.default.createElement(internal_default6, Object.assign({ options, filteringType, statusType, triggerVariant }, externalProps, baseComponentProps, { ref }, getAnalyticsMetadataAttribute({ component: componentAnalyticsMetadata })));
});
...
export {
  ...
  useSelect,
  internal_default6 as internal_default3,
  select_default
};
//# sourceMappingURL=chunk-F3SAUCE6.js.map

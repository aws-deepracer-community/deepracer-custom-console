...
import "/home/a171157/personal-repos/deep-racer/community-contributions/deepracer-custom-console/new/node_modules/@cloudscape-design/components/space-between/styles.scoped.css";
...
var InternalSpaceBetween = (0, import_react.forwardRef)((_a, ref) => {
  ...
  return import_react.default.createElement("div", Object.assign({}, baseProps, { className: clsx_m_default(baseProps.className, styles_css_default.root, styles_css_default[direction], styles_css_default[`${direction}-${size}`], alignItems && styles_css_default[`align-${alignItems}`]), ref: mergedRef }), flattenedChildren.map((child) => {
...
function SpaceBetween(_a) {
  ...
  return import_react2.default.createElement(internal_default, Object.assign({ direction }, props, baseComponentProps));
}
...
//# sourceMappingURL=chunk-4J74XILW.js.map

...
function createUseDiscoveredContent(componentName, controller) {
  return function useDiscoveredContent2({ type, header, children }) {
...
function createActionButton(testUtilClasses, action, buttonText, onButtonClick) {
  if (!action && buttonText) {
    action = import_react3.default.createElement(
      ...
      import_react3.default.createElement(internal_default2, { className: testUtilClasses.actionButton, onClick: onButtonClick, formAction: "none" }, buttonText)
    );
  }
...
var InternalAlert = import_react4.default.forwardRef((_a, ref) => {
  ...
  return import_react4.default.createElement(
    "div",
    Object.assign({}, baseProps, analyticsAttributes, { "aria-hidden": !visible, className: clsx_m_default(styles_css_default3.root, { [styles_css_default3.hidden]: !visible, [styles_css_default3["initial-hidden"]]: initialHidden }, baseProps.className), ref: mergedRef }),
    import_react4.default.createElement(
      ...
      import_react4.default.createElement(
        ...
        import_react4.default.createElement(
          "div",
          { className: clsx_m_default(styles_css_default3.alert, styles_css_default3[`type-${type}`], styles_css_default3[`icon-size-${size}`], hasAction && styles_css_default3["with-action"], dismissible && styles_css_default3["with-dismiss"], styles_css_default3[`breakpoint-${breakpoint}`]) },
          import_react4.default.createElement(
            "div",
            { className: styles_css_default3["alert-focus-wrapper"], tabIndex: -1, ref: focusRef },
            import_react4.default.createElement(
              "div",
            ...
            import_react4.default.createElement(
              ...
              import_react4.default.createElement("div", { className: clsx_m_default(header && styles_css_default3.header, headerReplacementType !== "original" ? styles_css_default3.hidden : styles_css_default2.header), ref: headerRef }, header),
              import_react4.default.createElement("div", { className: clsx_m_default(styles_css_default3["header-replacement"], headerReplacementType !== "replaced" ? styles_css_default3.hidden : styles_css_default2.header), ref: replacementHeaderRef }),
              import_react4.default.createElement("div", { className: clsx_m_default(styles_css_default3.content, contentReplacementType !== "original" && styles_css_default3.hidden), ref: contentRef }, children),
              import_react4.default.createElement("div", { className: clsx_m_default(styles_css_default3["content-replacement"], contentReplacementType !== "replaced" && styles_css_default3.hidden), ref: replacementContentRef })
            )
          ),
          import_react4.default.createElement(ActionsWrapper, { className: styles_css_default3.action, testUtilClasses: {
            actionSlot: styles_css_default3["action-slot"],
            actionButton: styles_css_default3["action-button"]
          ...
          dismissible && import_react4.default.createElement(
            "div",
            Object.assign({ className: styles_css_default3.dismiss }, getAnalyticsMetadataAttribute({
              action: "dismiss"
            })),
            import_react4.default.createElement(InternalButton, { className: styles_css_default3["dismiss-button"], variant: "icon", iconName: "close", formAction: "none", ariaLabel: dismissAriaLabel, onClick: () => fireNonCancelableEvent(onDismiss) })
          )
        )
      )
    )
...
var Alert = import_react5.default.forwardRef((_a, ref) => {
  ...
  const componentAnalyticsMetadata = {
    name: "awsui.Alert",
    label: `.${styles_css_default2.header}`,
    properties: {
      type
    }
  };
  return import_react5.default.createElement(internal_default3, Object.assign({ type, visible }, props, baseComponentProps, { ref }, getAnalyticsMetadataAttribute({ component: componentAnalyticsMetadata })));
});
...
//# sourceMappingURL=chunk-WVPHDKFQ.js.map

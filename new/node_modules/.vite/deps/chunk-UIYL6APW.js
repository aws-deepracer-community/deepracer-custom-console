...
function createSingletonState(_a2) {
  ...
  return function useSingletonState() {
    var _a3 = (0, import_react6.useState)(value), state = _a3[0], setState = _a3[1];
...
function useCurrentMode(elementRef) {
  var _a2 = (0, import_react7.useState)("light"), value = _a2[0], setValue = _a2[1];
...
function useDensityMode(elementRef) {
  var _a2 = (0, import_react7.useState)("comfortable"), value = _a2[0], setValue = _a2[1];
  useMutationObserver(elementRef, function(node) {
...
function useReducedMotion(elementRef) {
  var _a2 = (0, import_react7.useState)(false), value = _a2[0], setValue = _a2[1];
  useMutationObserver(elementRef, function(node) {
...
function useForwardFocus(mainRef, controlRef) {
  (0, import_react8.useImperativeHandle)(mainRef, () => ({
    focus(...args) {
      var _a2;
...
var InternalIcon = (_a2) => {
  ...
  useVisualRefresh();
  const [parentHeight, setParentHeight] = (0, import_react10.useState)(null);
  ...
  if (svg) {
    ...
    return import_react10.default.createElement("span", Object.assign({}, baseProps, { ref: mergedRef, "aria-hidden": "true", style: inlineStyles }), svg);
  }
  if (url) {
    return import_react10.default.createElement(
      "span",
      Object.assign({}, baseProps, { ref: mergedRef, style: inlineStyles }),
      import_react10.default.createElement("img", { src: url, alt })
    );
  }
  ...
  return import_react10.default.createElement("span", Object.assign({}, baseProps, {
...
function InternalSpinner(_a2) {
  ...
  return import_react11.default.createElement(
    ...
    import_react11.default.createElement("span", { className: clsx_m_default(styles_css_default3.circle, styles_css_default3["circle-left"]) }),
    import_react11.default.createElement("span", { className: clsx_m_default(styles_css_default3.circle, styles_css_default3["circle-right"]) })
  );
}
...
function ScreenreaderOnly(props) {
  return import_react12.default.createElement("span", Object.assign({}, props, { className: clsx_m_default(styles_css_default4.root, props.className) }));
}
...
// node_modules/@cloudscape-design/components/internal/components/live-region/index.js
var live_region_default = (0, import_react13.memo)(LiveRegion);
function LiveRegion(_a2) {
  ...
  const sourceRef = (0, import_react13.useRef)(null);
  ...
  return import_react13.default.createElement(
    ...
    null,
    visible && !source && import_react13.default.createElement(TagName, { ref: sourceRef, id }, children),
    import_react13.default.createElement(
      ScreenreaderOnly,
      Object.assign({}, restProps, { className: clsx_m_default(styles_css_default5.root, restProps.className) }),
      !visible && !source && import_react13.default.createElement(TagName, { ref: sourceRef, "aria-hidden": "true" }, children),
      import_react13.default.createElement("span", { ref: targetRef, "aria-atomic": "true", "aria-live": assertive ? "assertive" : "polite" })
    )
  );
}
...
var ButtonContext = (0, import_react14.createContext)({
  onClick: () => {
  }
});
function useButtonContext() {
  return (0, import_react14.useContext)(ButtonContext);
}
...
// node_modules/@cloudscape-design/components/internal/analytics/context/analytics-context.js
var FunnelContext = (0, import_react15.createContext)({
...
var FunnelStepContext = (0, import_react15.createContext)({
  stepNameSelector: "",
  stepNumber: 0,
...
var FunnelSubStepContext = (0, import_react15.createContext)({
  subStepId: "",
  subStepSelector: "",
  subStepNameSelector: "",
...
var FunnelNameSelectorContext = (0, import_react15.createContext)(void 0);
...
var useFunnelSubStep = () => {
  const context = (0, import_react16.useContext)(FunnelSubStepContext);
...
var useFunnelStep = () => {
  const context = (0, import_react16.useContext)(FunnelStepContext);
  return context;
};
var useFunnel = () => {
  const context = (0, import_react16.useContext)(FunnelContext);
...
var useFunnelNameSelector = () => {
  const context = (0, import_react16.useContext)(FunnelNameSelectorContext);
  return context;
};
...
//# sourceMappingURL=chunk-UIYL6APW.js.map
